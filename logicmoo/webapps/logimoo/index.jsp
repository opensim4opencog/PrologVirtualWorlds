<%@ page language="java" import="logicmoo.*, org.opencyc.constraintsolver.*,org.opencyc.cycobject.*, org.opencyc.creation.*, org.opencyc.kif.*, org.opencyc.jsp.*, org.opencyc.util.*,org.opencyc.api.*,org.opencyc.inferencesupport.*,org.opencyc.webserver.*, java.util.*,com.oreilly.servlet.*,com.oreilly.servlet.multipart.*,java.io.*" %>
...
menu[0][4] = new Item('  Areas', '#', 'workarea', 40, 10, 7);
menu[0][5] = new Item('  Objects', '#', 'workarea', 40, 10, 8);
menu[0][6] = new Item(' <nobr>NPC Agent', '#', 'workarea', 70, 10, 6);
menu[0][7] = new Item('  Microtheory', '#', '', 60, 10, 4);
menu[0][8] = new Item('  Help', 'http://logicmoo.sourceforge.net', '_top', 40, 10, 0);
...
menu[1][1] = new Item('Browse', 'http://12.225.207.235:8036/cgi-bin/cyccgi/cg?cb-start', 'workarea', defLength, 0, 0);
...
menu[1][3] = new Item('Ask', 'http://12.225.207.235:8036/cgi-bin/cyccgi/cg?cb-handle-ask', 'workarea', defLength, 0, 0);
menu[1][4] = new Item('Assert', 'http://12.225.207.235:8036/cgi-bin/cyccgi/cg?cb-assert', 'workarea', defLength, 0, 0);
menu[1][5] = new Item('SubL', 'http://12.225.207.235:8036/cgi-bin/cyccgi/cg?cb-handle-interactor', 'workarea', defLength, 0, 0);
menu[1][6] = new Item('Login', 'http://12.225.207.235:8036/cgi-bin/cyccgi/cg?cb-login', 'workarea', defLength, 0, 0);

// Create menu.
menu[2] = new Array();
menu[2][0] = new Menu(true, '>', 0, 22, 80, defOver, defBack, 'itemBorder', 'itemText');
menu[2][1] = new Item('Browse', 'http://12.225.207.235:8036/cgi-bin/cyccgi/cg?cb-start', 'workarea', defLength, 0, 0);
menu[2][2] = new Item('Telnet', 'telnet://12.225.207.235:4444', 'workarea', defLength, 0, 0);
...
menu[3][4] = new Item('Constant', 'http://12.225.207.235:8036/cgi-bin/cyccgi/cg?cb-create', 'workarea', defLength, 0, 0);
...
menu[6][4] = new Item('  <nobr>Create Role', 'createrole.jsp', 'workarea',  defLength, 0, 0);
menu[6][5] = new Item('  <nobr>Edit Roles', 'roles.jsp', 'workarea',  defLength, 0, 0);
menu[6][6] = new Item('  <nobr>Create Plan', 'createplan.jsp', 'workarea',  defLength, 0, 0);
menu[6][7] = new Item('  <nobr>Edit Plans', 'plans.jsp', 'workarea',  defLength, 0, 0);

menu[7] = new Array();
menu[7][0] = new Menu(true, '>', 0, 22, 90, defOver, defBack, 'itemBorder', 'itemText');
menu[7][1] = new Item('  <nobr>Create Area', 'createarea.jsp', 'workarea',  defLength, 0, 0);
menu[7][2] = new Item('  <nobr>Edit Areas', 'areas.jsp', 'workarea',  defLength, 0, 0);

menu[8] = new Array();
menu[8][0] = new Menu(true, '>', 0, 22, 90, defOver, defBack, 'itemBorder', 'itemText');
menu[8][1] = new Item('  <nobr>Create Object', 'createobject.jsp', 'workarea',  defLength, 0, 0);
menu[8][2] = new Item('  <nobr>Edit Objects', 'objects.jsp', 'workarea',  defLength, 0, 0);
...
if (pageContext.getSession().getAttribute("login")==null) {
    out.print("http://12.225.207.235:8036/cgi-bin/cyccgi/cg?cb-login");
