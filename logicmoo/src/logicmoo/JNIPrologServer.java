...
public class JNIPrologServer extends Thread {
        ...
        // Testing interface for invoking from prolog
        public synchronized static String sayHello(String name) {
                String msg = "Hello " + name.toString();
...
//                interfaceList.append(",[");
        ...
        public synchronized static String toPrologString(String someName) {
                return "'" + someName + "'";
        }
