...
public class Exit extends PartiallyTangible implements JamudEventTrigger {
    ...
    // Overrides on CycThing
    private CycFort cycFort = CycMoo.makeCycConstantSafe("load");
    public CycFort getCycFort() { return cycFort;}
    public void setCycFort(CycFort cycFortIn) { this.cycFort = cycFortIn;}
    public String getCycFortString() { return this.cycFort.toString();}
    public void setCycFortString(String cycFortIn) { this.cycFort = makeCycFort(cycFortIn);}
    // Overrides on CycThing


    private String targetCycFort;
    public String getTargetCycFort() { return targetCycFort;}
    public void setTargetCycFort(String targetCycFort) { this.targetCycFort = targetCycFort;}

    private Room targetRoom;
    public Room getTargetRoom() { return targetRoom;}
    public void setTargetRoom(Room targetRoom) { this.targetRoom = targetRoom;}
    ...
    public String getInMessage(Body user) {
    ...
    public String getOutMessage(Body user) {
	...
	e.targetCycFort = xml.getAttribute(PROPERTY_TARGET);
	...
	e.setDesc(Util.format(xml.getContent(), 70, true));
	...
	xml.setAttribute(PROPERTY_TARGET, targetCycFort);
