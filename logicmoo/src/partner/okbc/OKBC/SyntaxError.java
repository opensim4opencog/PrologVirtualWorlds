...
public class SyntaxError extends AbstractError {
  public Node erring_input = null;

  public SyntaxError () {}

  public SyntaxError (Node the_erring_input) {
    erring_input = the_erring_input;
  }
  ...
  public void init_from_plist (Node plist) {
    erring_input = 
      plistGet(Symbol.keyword("ERRING-INPUT"), plist);
    super.init_from_plist(plist);
  }

  public Node decode_to_plist() {
    return Cons.append_cons(Cons.list(Symbol.keyword("ERRING-INPUT"),
                                      (erring_input == null ?
                                       Node._NIL :
                                       erring_input)),
