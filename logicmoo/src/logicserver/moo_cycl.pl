...
isa('Fn'(_G16270, _G16276), _G16264).

genls('Fn'(_G16312, _G16318), _G16306).

isa(_G15534, 'Individual').

isa(_G15492, 'Function').

isa(_G15555, 'Microtheory').

isa(_G15534, 'Quantifier').

reflexive_args(_G15576).

isa(_G15445, _G15451).

genls(_G15583, _G15589).
...
%   (relation-located genls 2 deduceSurfaceer (external-agent-must-bind external-agent-must-bind) deduceSurface  always )  
'relation-located'(genls, 2, deduceSurfaceer, 'external-agent-must-bind'('external-agent-must-bind'), deduceSurface, always).

%   (relation-located deduceSurface 1 deduceSurfaceer (external-agent-must-bind) deduceSurface  always )  
'relation-located'(deduceSurface, 1, deduceSurfaceer, 'external-agent-must-bind', deduceSurface, always).

%   (relation-located ?Pred ?Valence deduceSurfaceer ??? deduceSurface  always )  
'relation-located'(_G15901, _G15919, deduceSurfaceer, _G15913, _G15925, always).
...
%   (relation-located moo-console 0 kernel  (EmptySetFn) moo-console  always )  
'relation-located'('moo-console', 0, kernel, 'EmptySetFn', 'moo-console', always).
...
%   (relation-located moo-A-do-retract-list 4 kernel  (SetFn ?h642  ?h644  ?h646  ?h648) moo-A-do-retract-list  always )  
'relation-located'('moo-A-do-retract-list', 4, kernel, 'SetFn'(_G17752, _G17758, _G17764, _G17770), 'moo-A-do-retract-list', always).
...
%   (relation-located moo-U-setup-confirmation 1 kernel  (SetFn ?h639) moo-U-setup-confirmation  always )  
'relation-located'('moo-U-setup-confirmation', 1, kernel, 'SetFn'(_G16615), 'moo-U-setup-confirmation', always).
...
%   (relation-located moo-P-chars-to-term 3 kernel  (SetFn ?h641  ?h643  ?h645) moo-P-chars-to-term  always )  
'relation-located'('moo-P-chars-to-term', 3, kernel, 'SetFn'(_G17229, _G17235, _G17241), 'moo-P-chars-to-term', always).
...
%   (relation-located moo 3 kernel  (SetFn ?h641  ?h643  ?h645) moo  always )  
'relation-located'(moo, 3, kernel, 'SetFn'(_G16461, _G16467, _G16473), moo, always).
...
%   (relation-located ua-retractall 6 kernel  (SetFn ?h644  ?h646  ?h648  ?h650  ?h652  ?h654) ua-retractall  always )  
'relation-located'('ua-retractall', 6, kernel, 'SetFn'(_G18126, _G18132, _G18138, _G18144, _G18150, _G18156), 'ua-retractall', always).
...
%   (relation-located moo-H-assert 3 kernel  (SetFn ?h641  ?h643  ?h645) moo-H-assert  always )  
'relation-located'('moo-H-assert', 3, kernel, 'SetFn'(_G16893, _G16899, _G16905), 'moo-H-assert', always).

%   (relation-located moo-X-assert 5 kernel  (SetFn ?h643  ?h645  ?h647  ?h649  ?h651) moo-X-assert  always )  
'relation-located'('moo-X-assert', 5, kernel, 'SetFn'(_G17747, _G17753, _G17759, _G17765, _G17771), 'moo-X-assert', always).

%   (relation-located moo-A-do-update-list 4 kernel  (SetFn ?h642  ?h644  ?h646  ?h648) moo-A-do-update-list  always )  
'relation-located'('moo-A-do-update-list', 4, kernel, 'SetFn'(_G17704, _G17710, _G17716, _G17722), 'moo-A-do-update-list', always).

%   (relation-located moo-H-resource-info 3 kernel  (SetFn ?h641  ?h643  ?h645) moo-H-resource-info  always )  
'relation-located'('moo-H-resource-info', 3, kernel, 'SetFn'(_G17229, _G17235, _G17241), 'moo-H-resource-info', always).

%   (relation-located moo-X-retract-new-1 5 kernel  (SetFn ?h643  ?h645  ?h647  ?h649  ?h651) moo-X-retract-new-1  always )  
'relation-located'('moo-X-retract-new-1', 5, kernel, 'SetFn'(_G18179, _G18185, _G18191, _G18197, _G18203), 'moo-X-retract-new-1', always).
...
%   (relation-located moo-H-resource-delete 3 kernel  (SetFn ?h641  ?h643  ?h645) moo-H-resource-delete  always )  
'relation-located'('moo-H-resource-delete', 3, kernel, 'SetFn'(_G17325, _G17331, _G17337), 'moo-H-resource-delete', always).

%   (relation-located moo-H-resource-create 3 kernel  (SetFn ?h641  ?h643  ?h645) moo-H-resource-create  always )  
'relation-located'('moo-H-resource-create', 3, kernel, 'SetFn'(_G17325, _G17331, _G17337), 'moo-H-resource-create', always).

%   (relation-located retractall 1 kernel  (SetFn ?h639) retractall  always )  
'relation-located'(retractall, 1, kernel, 'SetFn'(_G15847), retractall, always).

%   (relation-located moo-H-optional-setting 2 kernel  (SetFn ?h640  ?h642) moo-H-optional-setting  always )  
'relation-located'('moo-H-optional-setting', 2, kernel, 'SetFn'(_G16946, _G16952), 'moo-H-optional-setting', always).
...
%   (relation-located moo-X-retractall-new-1 5 kernel  (SetFn ?h643  ?h645  ?h647  ?h649  ?h651) moo-X-retractall-new-1  always )  
'relation-located'('moo-X-retractall-new-1', 5, kernel, 'SetFn'(_G18323, _G18329, _G18335, _G18341, _G18347), 'moo-X-retractall-new-1', always).
...
%   (relation-located never-retractall 1 kernel  (SetFn ?h639) never-retractall  always )  
'relation-located'('never-retractall', 1, kernel, 'SetFn'(_G16135), 'never-retractall', always).
...
%   (relation-located clear-quit-request 0 kernel  (EmptySetFn) clear-quit-request  always )  
'relation-located'('clear-quit-request', 0, kernel, 'EmptySetFn', 'clear-quit-request', always).
...
%   (relation-located deduce-branch 6 kernel  (SetFn ?h644  ?h646  ?h648  ?h650  ?h652  ?h654) deduce-branch  always )  
'relation-located'('deduce-branch', 6, kernel, 'SetFn'(_G18078, _G18084, _G18090, _G18096, _G18102, _G18108), 'deduce-branch', always).
...
%   (relation-located moo-H-request 3 kernel  (SetFn ?h641  ?h643  ?h645) moo-H-request  always )  
'relation-located'('moo-H-request', 3, kernel, 'SetFn'(_G16845, _G16851, _G16857), 'moo-H-request', always).
...
%   (relation-located moo-C-make-list-q 5 kernel  (SetFn ?h643  ?h645  ?h647  ?h649  ?h651) moo-C-make-list-q  always )  
'relation-located'('moo-C-make-list-q', 5, kernel, 'SetFn'(_G17987, _G17993, _G17999, _G18005, _G18011), 'moo-C-make-list-q', always).
...
%   (relation-located filter-explaination 5 kernel  (SetFn ?h643  ?h645  ?h647  ?h649  ?h651) filter-explaination  always )  
'relation-located'('filter-explaination', 5, kernel, 'SetFn'(_G17651, _G17657, _G17663, _G17669, _G17675), 'filter-explaination', always).
...
%   (relation-located moo-P-file-line-writeFmt 6 kernel  (SetFn ?h644  ?h646  ?h648  ?h650  ?h652  ?h654) moo-P-file-line-writeFmt  always )  
'relation-located'('moo-P-file-line-writeFmt', 6, kernel, 'SetFn'(_G18654, _G18660, _G18666, _G18672, _G18678, _G18684), 'moo-P-file-line-writeFmt', always).
...
%   (relation-located compile-functions-deterministicly-for-request 3 kernel  (SetFn ?h641  ?h643  ?h645) compile-functions-deterministicly-for-request  always )  
'relation-located'('compile-functions-deterministicly-for-request', 3, kernel, 'SetFn'(_G18285, _G18291, _G18297), 'compile-functions-deterministicly-for-request', always).
...
%   (relation-located compile-functions-nondeterministicly-for-request-list 4 kernel  (SetFn ?h642  ?h644  ?h646  ?h648) compile-functions-nondeterministicly-for-request-list  always )  
'relation-located'('compile-functions-nondeterministicly-for-request-list', 4, kernel, 'SetFn'(_G19096, _G19102, _G19108, _G19114), 'compile-functions-nondeterministicly-for-request-list', always).

%   (relation-located compile-functions-nondeterministicly-for-request 4 kernel  (SetFn ?h642  ?h644  ?h646  ?h648) compile-functions-nondeterministicly-for-request  always )  
'relation-located'('compile-functions-nondeterministicly-for-request', 4, kernel, 'SetFn'(_G18856, _G18862, _G18868, _G18874), 'compile-functions-nondeterministicly-for-request', always).
...
%   (relation-located moo-console-loop 0 kernel  (EmptySetFn) moo-console-loop  always )  
'relation-located'('moo-console-loop', 0, kernel, 'EmptySetFn', 'moo-console-loop', always).
...
%   (relation-located moo-C-request-based-on-language 5 kernel  (SetFn ?h643  ?h645  ?h647  ?h649  ?h651) moo-C-request-based-on-language  always )  
'relation-located'('moo-C-request-based-on-language', 5, kernel, 'SetFn'(_G18563, _G18569, _G18575, _G18581, _G18587), 'moo-C-request-based-on-language', always).
...
%   (relation-located moo-H-command 1 kernel  (SetFn ?h639) moo-H-command  always )  
'relation-located'('moo-H-command', 1, kernel, 'SetFn'(_G16087), 'moo-H-command', always).

%   (relation-located moo-H-command 2 kernel  (SetFn ?h640  ?h642) moo-H-command  always )  
'relation-located'('moo-H-command', 2, kernel, 'SetFn'(_G16514, _G16520), 'moo-H-command', always).
...
%   (relation-located moo-P-wff 3 kernel  (SetFn ?h641  ?h643  ?h645) moo-P-wff  always )  
'relation-located'('moo-P-wff', 3, kernel, 'SetFn'(_G16749, _G16755, _G16761), 'moo-P-wff', always).
...
%   (relation-located moo-H-use-kr-datafile 3 kernel  (SetFn ?h641  ?h643  ?h645) moo-H-use-kr-datafile  always )  
'relation-located'('moo-H-use-kr-datafile', 3, kernel, 'SetFn'(_G17325, _G17331, _G17337), 'moo-H-use-kr-datafile', always).
...
%   (relation-located show-request 1 kernel  (SetFn ?h639) show-request  always )  
'relation-located'('show-request', 1, kernel, 'SetFn'(_G15847), 'show-request', always).

%   (relation-located moo-U-option-set 2 kernel  (SetFn ?h640  ?h642) moo-U-option-set  always )  
'relation-located'('moo-U-option-set', 2, kernel, 'SetFn'(_G16658, _G16664), 'moo-U-option-set', always).
...
%   (relation-located nd-moo-H-command 2 kernel  (SetFn ?h640  ?h642) nd-moo-H-command  always )  
'relation-located'('nd-moo-H-command', 2, kernel, 'SetFn'(_G16658, _G16664), 'nd-moo-H-command', always).
...
%   (relation-located moo-call 2 kernel  (SetFn ?h640  ?h642) moo-call  always )  
'relation-located'('moo-call', 2, kernel, 'SetFn'(_G16274, _G16280), 'moo-call', always).
...
%   (relation-located moo-P-parse-proposition 3 kernel  (SetFn ?h641  ?h643  ?h645) moo-P-parse-proposition  always )  
'relation-located'('moo-P-parse-proposition', 3, kernel, 'SetFn'(_G17421, _G17427, _G17433), 'moo-P-parse-proposition', always).
...
%   (relation-located moo-U-collect-confirmation 1 kernel  (SetFn ?h639) moo-U-collect-confirmation  always )  
'relation-located'('moo-U-collect-confirmation', 1, kernel, 'SetFn'(_G16711), 'moo-U-collect-confirmation', always).
...
%   (relation-located test-moo-compiler 0 kernel  (EmptySetFn) test-moo-compiler  always )  
'relation-located'('test-moo-compiler', 0, kernel, 'EmptySetFn', 'test-moo-compiler', always).
...
%   (relation-located moo-X-assert-new 5 kernel  (SetFn ?h643  ?h645  ?h647  ?h649  ?h651) moo-X-assert-new  always )  
'relation-located'('moo-X-assert-new', 5, kernel, 'SetFn'(_G17939, _G17945, _G17951, _G17957, _G17963), 'moo-X-assert-new', always).
...
%   (relation-located moo-H-retract 3 kernel  (SetFn ?h641  ?h643  ?h645) moo-H-retract  always )  
'relation-located'('moo-H-retract', 3, kernel, 'SetFn'(_G16941, _G16947, _G16953), 'moo-H-retract', always).

%   (relation-located moo-X-retract 5 kernel  (SetFn ?h643  ?h645  ?h647  ?h649  ?h651) moo-X-retract  always )  
'relation-located'('moo-X-retract', 5, kernel, 'SetFn'(_G17795, _G17801, _G17807, _G17813, _G17819), 'moo-X-retract', always).
...
%   (relation-located moo-C-assert-based-on-language-first 4 kernel  (SetFn ?h642  ?h644  ?h646  ?h648) moo-C-assert-based-on-language-first  always )  
'relation-located'('moo-C-assert-based-on-language-first', 4, kernel, 'SetFn'(_G18472, _G18478, _G18484, _G18490), 'moo-C-assert-based-on-language-first', always).

%   (relation-located moo-C-assert-based-on-language 5 kernel  (SetFn ?h643  ?h645  ?h647  ?h649  ?h651) moo-C-assert-based-on-language  always )  
'relation-located'('moo-C-assert-based-on-language', 5, kernel, 'SetFn'(_G18611, _G18617, _G18623, _G18629, _G18635), 'moo-C-assert-based-on-language', always).
...
%   (relation-located belief-module-request 4 kernel  (SetFn ?h642  ?h644  ?h646  ?h648) belief-module-request  always )  
'relation-located'('belief-module-request', 4, kernel, 'SetFn'(_G17704, _G17710, _G17716, _G17722), 'belief-module-request', always).
...
%   (relation-located moo-console-end-char 2 kernel  (SetFn ?h640  ?h642) moo-console-end-char  always )  
'relation-located'('moo-console-end-char', 2, kernel, 'SetFn'(_G16850, _G16856), 'moo-console-end-char', always).

%   (relation-located moo-console-scan-text 2 kernel  (SetFn ?h640  ?h642) moo-console-scan-text  always )  
'relation-located'('moo-console-scan-text', 2, kernel, 'SetFn'(_G16898, _G16904), 'moo-console-scan-text', always).
...
%   (relation-located ua-request 6 kernel  (SetFn ?h644  ?h646  ?h648  ?h650  ?h652  ?h654) ua-request  always )  
'relation-located'('ua-request', 6, kernel, 'SetFn'(_G17886, _G17892, _G17898, _G17904, _G17910, _G17916), 'ua-request', always).
...
%   (relation-located moo-console-read-stdin 2 kernel  (SetFn ?h640  ?h642) moo-console-read-stdin  always )  
'relation-located'('moo-console-read-stdin', 2, kernel, 'SetFn'(_G16946, _G16952), 'moo-console-read-stdin', always).
...
%   (relation-located moo-H-relation-add 6 kernel  (SetFn ?h644  ?h646  ?h648  ?h650  ?h652  ?h654) moo-H-relation-add  always )  
'relation-located'('moo-H-relation-add', 6, kernel, 'SetFn'(_G18462, _G18468, _G18474, _G18480, _G18486, _G18492), 'moo-H-relation-add', always).
...
%   (relation-located moo-console-get-chars0 1 kernel  (SetFn ?h639) moo-console-get-chars0  always )  
'relation-located'('moo-console-get-chars0', 1, kernel, 'SetFn'(_G16615), 'moo-console-get-chars0', always).

%   (relation-located request-done 1 kernel  (SetFn ?h639) request-done  always )  
'relation-located'('request-done', 1, kernel, 'SetFn'(_G15847), 'request-done', always).

%   (relation-located belief-module-create-request-workspace 1 kernel  (SetFn ?h639) belief-module-create-request-workspace  always )  
'relation-located'('belief-module-create-request-workspace', 1, kernel, 'SetFn'(_G17239), 'belief-module-create-request-workspace', always).
...
%   (relation-located moo-console-readstring-stdin 1 kernel  (SetFn ?h639) moo-console-readstring-stdin  always )  
'relation-located'('moo-console-readstring-stdin', 1, kernel, 'SetFn'(_G16807), 'moo-console-readstring-stdin', always).
...
%   (relation-located moo-H-relation-info 6 kernel  (SetFn ?h644  ?h646  ?h648  ?h650  ?h652  ?h654) moo-H-relation-info  always )  
'relation-located'('moo-H-relation-info', 6, kernel, 'SetFn'(_G18510, _G18516, _G18522, _G18528, _G18534, _G18540), 'moo-H-relation-info', always).
...
%   (relation-located moo-H-retractall 3 kernel  (SetFn ?h641  ?h643  ?h645) moo-H-retractall  always )  
'relation-located'('moo-H-retractall', 3, kernel, 'SetFn'(_G17085, _G17091, _G17097), 'moo-H-retractall', always).

%   (relation-located moo-X-retractall 5 kernel  (SetFn ?h643  ?h645  ?h647  ?h649  ?h651) moo-X-retractall  always )  
'relation-located'('moo-X-retractall', 5, kernel, 'SetFn'(_G17939, _G17945, _G17951, _G17957, _G17963), 'moo-X-retractall', always).
...
%   (relation-located moo-H-relation-delete 6 kernel  (SetFn ?h644  ?h646  ?h648  ?h650  ?h652  ?h654) moo-H-relation-delete  always )  
'relation-located'('moo-H-relation-delete', 6, kernel, 'SetFn'(_G18606, _G18612, _G18618, _G18624, _G18630, _G18636), 'moo-H-relation-delete', always).
...
%   (relation-located moo-C-retract-based-on-language 5 kernel  (SetFn ?h643  ?h645  ?h647  ?h649  ?h651) moo-C-retract-based-on-language  always )  
'relation-located'('moo-C-retract-based-on-language', 5, kernel, 'SetFn'(_G18659, _G18665, _G18671, _G18677, _G18683), 'moo-C-retract-based-on-language', always).
...
%   (relation-located continue-the-request 0 kernel  (EmptySetFn) continue-the-request  always )  
'relation-located'('continue-the-request', 0, kernel, 'EmptySetFn', 'continue-the-request', always).
...
%   (relation-located moo-U-set-session-defaults 2 kernel  (SetFn ?h640  ?h642) moo-U-set-session-defaults  always )  
'relation-located'('moo-U-set-session-defaults', 2, kernel, 'SetFn'(_G17138, _G17144), 'moo-U-set-session-defaults', always).
...
%   (relation-located moo-U-option-lookup 3 kernel  (SetFn ?h641  ?h643  ?h645) moo-U-option-lookup  always )  
'relation-located'('moo-U-option-lookup', 3, kernel, 'SetFn'(_G17229, _G17235, _G17241), 'moo-U-option-lookup', always).
...
%   (relation-located moo-H-context-info 3 kernel  (SetFn ?h641  ?h643  ?h645) moo-H-context-info  always )  
'relation-located'('moo-H-context-info', 3, kernel, 'SetFn'(_G17181, _G17187, _G17193), 'moo-H-context-info', always).
...
%   (relation-located moo-H-context-link 3 kernel  (SetFn ?h641  ?h643  ?h645) moo-H-context-link  always )  
'relation-located'('moo-H-context-link', 3, kernel, 'SetFn'(_G17181, _G17187, _G17193), 'moo-H-context-link', always).
...
%   (relation-located moo-H-context-list 1 kernel  (SetFn ?h639) moo-H-context-list  always )  
'relation-located'('moo-H-context-list', 1, kernel, 'SetFn'(_G16327), 'moo-H-context-list', always).

%   (relation-located moo-H-context-save 2 kernel  (SetFn ?h640  ?h642) moo-H-context-save  always )  
'relation-located'('moo-H-context-save', 2, kernel, 'SetFn'(_G16754, _G16760), 'moo-H-context-save', always).

%   (relation-located moo-H-context-dirty 1 kernel  (SetFn ?h639) moo-H-context-dirty  always )  
'relation-located'('moo-H-context-dirty', 1, kernel, 'SetFn'(_G16375), 'moo-H-context-dirty', always).
...
%   (relation-located moo-H-context-merge 2 kernel  (SetFn ?h640  ?h642) moo-H-context-merge  always )  
'relation-located'('moo-H-context-merge', 2, kernel, 'SetFn'(_G16802, _G16808), 'moo-H-context-merge', always).
...
%   (relation-located moo-H-context-delete 1 kernel  (SetFn ?h639) moo-H-context-delete  always )  
'relation-located'('moo-H-context-delete', 1, kernel, 'SetFn'(_G16423), 'moo-H-context-delete', always).
...
%   (relation-located moo-H-context-delete 2 kernel  (SetFn ?h640  ?h642) moo-H-context-delete  always )  
'relation-located'('moo-H-context-delete', 2, kernel, 'SetFn'(_G16850, _G16856), 'moo-H-context-delete', always).

%   (relation-located moo-H-context-delete 3 kernel  (SetFn ?h641  ?h643  ?h645) moo-H-context-delete  always )  
'relation-located'('moo-H-context-delete', 3, kernel, 'SetFn'(_G17277, _G17283, _G17289), 'moo-H-context-delete', always).

%   (relation-located moo-H-context-create 3 kernel  (SetFn ?h641  ?h643  ?h645) moo-H-context-create  always )  
'relation-located'('moo-H-context-create', 3, kernel, 'SetFn'(_G17277, _G17283, _G17289), 'moo-H-context-create', always).
...
%   (relation-located moo-H-context-changed 2 kernel  (SetFn ?h640  ?h642) moo-H-context-changed  always )  
'relation-located'('moo-H-context-changed', 2, kernel, 'SetFn'(_G16898, _G16904), 'moo-H-context-changed', always).
...
%   (relation-located moo-A-do-assert-list 4 kernel  (SetFn ?h642  ?h644  ?h646  ?h648) moo-A-do-assert-list  always )  
'relation-located'('moo-A-do-assert-list', 4, kernel, 'SetFn'(_G17704, _G17710, _G17716, _G17722), 'moo-A-do-assert-list', always).

%   (relation-located moo-H-context-unlink 3 kernel  (SetFn ?h641  ?h643  ?h645) moo-H-context-unlink  always )  
'relation-located'('moo-H-context-unlink', 3, kernel, 'SetFn'(_G17277, _G17283, _G17289), 'moo-H-context-unlink', always).
...
%   (relation-located moo-H-constant-info 3 kernel  (SetFn ?h641  ?h643  ?h645) moo-H-constant-info  always )  
'relation-located'('moo-H-constant-info', 3, kernel, 'SetFn'(_G17229, _G17235, _G17241), 'moo-H-constant-info', always).
...
%   (relation-located moo-U-setup-notify 1 kernel  (SetFn ?h639) moo-U-setup-notify  always )  
'relation-located'('moo-U-setup-notify', 1, kernel, 'SetFn'(_G16327), 'moo-U-setup-notify', always).

%   (relation-located moo-H-constant-create 4 kernel  (SetFn ?h642  ?h644  ?h646  ?h648) moo-H-constant-create  always )  
'relation-located'('moo-H-constant-create', 4, kernel, 'SetFn'(_G17752, _G17758, _G17764, _G17770), 'moo-H-constant-create', always).

%   (relation-located moo-X-assert-new-1 5 kernel  (SetFn ?h643  ?h645  ?h647  ?h649  ?h651) moo-X-assert-new-1  always )  
