...
public class FacetAlreadyExists extends AbstractError {
  public Node facet = null;

  public FacetAlreadyExists () {}

  public FacetAlreadyExists (Node the_facet,
                             Node the_kb) {
    facet = the_facet;
    kb = the_kb;
  }
  ...
  public Node decode_to_plist() {
    return Cons.append_cons(Cons.list(Symbol.keyword("FACET"),
                                      (facet == null ?
                                       Node._NIL :
                                       facet),
                                      Symbol.keyword("KB"),
