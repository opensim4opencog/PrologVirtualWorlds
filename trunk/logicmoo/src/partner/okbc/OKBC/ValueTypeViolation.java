...
public class ValueTypeViolation extends ConstraintViolation {

  public ValueTypeViolation () {}

  public ValueTypeViolation (Node the_kb,
                             Node the_facet,
                             Node the_slot_type,
                             Node the_slot,
                             Node the_frame,
  ...
  public String report () {
    return "Violation of valuetype constraint " +
           constraint +
           " in slot " +
           slot +
           " in frame " +
