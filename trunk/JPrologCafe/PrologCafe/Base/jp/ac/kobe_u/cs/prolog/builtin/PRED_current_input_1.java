...
final Object[] engine_aregs = engine.getAreg();
    ...
    a1 = deref(a1);
    if (isVariable(a1))
 jp.ac.kobe_u.cs.prolog.lang.VariableTermBase.bind((VariableTerm) a1, makeJavaObject(engine.getCurrentInput()));
    else if (isJavaObject(a1)){
 if (!unify(a1, makeJavaObject(engine.getCurrentInput())))
