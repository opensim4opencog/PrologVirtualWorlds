/* PRED_java_set_declared_field0_3 - at Sun Sep 21 05:38:59 PDT 2008 */
...
/* import jp.ac.kobe_u.cs.prolog.builtin.PRED_java_set_declared_field0_3; */
...
public class PRED_java_set_declared_field0_3 extends JavaPredicate {
  ...
  * 
  */
  private static final long serialVersionUID = -3021190829504290606L;
  Object arg1;
  Object arg2;
  Object arg3;
  ...
  public PRED_java_set_declared_field0_3() {
    /* flow_0_0_EmptyBlock_2142386190
    */
    /* empty */}
  ...
  public String toString() {
    ...
    */
    return "java_set_declared_field0(" + this.arg1 + "," + this.arg2 + "," + this.arg3 + ")";
  }

  public PRED_java_set_declared_field0_3(Object a1, Object a2, Object a3, Predicate cont) {
  ...
  public Predicate exec(Prolog engine) {
    ...
    */
    ...
    try {
      ...
      field = clazz.getDeclaredField(nameUQ(a2));
      a3 = deref(a3);
      if (isJavaObject(a3))
        value = toJava(a3);
      else
