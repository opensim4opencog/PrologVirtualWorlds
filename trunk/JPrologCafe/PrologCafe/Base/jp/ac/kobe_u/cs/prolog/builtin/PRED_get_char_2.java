/* PRED_get_char_2 - at Sun Sep 21 05:38:59 PDT 2008 */
...
return 2;
      ...
      boolean inCharacter(Object t) {
        /* flow_0_0_IfThenElseBlock_2146411664
 */
if (!isAtomTerm(t))
 return false;
    if (prologEquals(t, PRED_get_char_2.SYM_EOF))
 return true;
 ...
 return true;
    ...
    /* flow_0_0_EmptyBlock_1310534542
 */
/* empty */}
...
// */
//return "get_char(" + this.arg1 + "," + this.arg2 + ")";
//}
    @Override
...
final Object[] engine_aregs = engine.getAreg();
 ...
 if (c < 0){
     if (!unify(a2, PRED_get_char_2.SYM_EOF))
