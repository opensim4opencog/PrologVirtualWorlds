  ...
  */
  ...
  public Predicate exec(Prolog engine) {
    ...
    */
    ...
    a1 = deref(a1);
    if (isNil(a1)) return this.fail(engine);
    if (!isListTerm(a1)) throw new IllegalTypeException(this, 1, "list", a1);
    Object x = Prolog.Nil;
    for (Object tmp = a1; !isNil(tmp); tmp = deref(rest((Object) tmp))) {
      if (!isListTerm(tmp)) throw new IllegalTypeException(this, 1, "list", a1);
      final Object car = deref(first((Object) tmp));
      if (isVariable(car)) throw new PInstantiationException(this, 1);
      if (!isInteger(car)) throw new RepresentationException(this, 1, "integer");
