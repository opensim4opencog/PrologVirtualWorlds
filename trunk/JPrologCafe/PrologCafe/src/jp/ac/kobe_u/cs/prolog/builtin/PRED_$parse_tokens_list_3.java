...
/**
 ...
 @version 1.0-dmiles
*/
class PRED_$parse_tokens_list_3 extends PredicateBase {
    static /*Symbol*/Object s1 = makeAtom("[]");
    static /*Symbol*/Object s2 = makeAtom("]");
    static /*IntegerTerm*/Object si3 = makeInteger(999);
    ...
    public PRED_$parse_tokens_list_3(Object a1, Object a2, Object a3, Predicate cont) {
        arg1 = a1;
        arg2 = a2;
        arg3 = a3;
        this.cont = cont;
    ...
    public String nameUQ() { return "$parse_tokens_list"; }
...
default: return newIndexOutOfBoundsException("getarg", i0,null);  }   }
    ...
    public String toPrologString(java.util.Collection newParam) {
        return "'$parse_tokens_list'(" + argString(arg1,newParam) + "," + argString(arg2,newParam) + "," + argString(arg3,newParam) + ")";
    }
...
class PRED_$parse_tokens_list_3_1 extends PRED_$parse_tokens_list_3 {
    ...
    // '$parse_tokens_list'([], [']'|A], A):-!
        ...
        a3 = engine_aregs[3];
        cont = engine.cont;
    // '$parse_tokens_list'([], [']'|A], A):-['$neck_cut']
        a1 = deref( a1);
        if (isAtomTerm(a1)){
