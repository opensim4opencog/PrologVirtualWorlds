...
/**
 ...
 @version 1.0-dmiles
*/
public class PRED_numbervars_3 extends PredicateBase {
    static /*IntegerTerm*/Object si1 = makeInteger(0);

    public Object arg1, arg2, arg3;

    public PRED_numbervars_3(Object a1, Object a2, Object a3, Predicate cont) {
        arg1 = a1;
        arg2 = a2;
        arg3 = a3;
        this.cont = cont;
...
default: return newIndexOutOfBoundsException("getarg", i0,null);  }   }
    ...
    // numbervars(A, B, C):-['$get_level'(D), integer(B), '$greater_or_equal'(B, 0), '$cut'(D), '$numbervars'(A, B, C)]
        ...
        try {
            if (arithCompareTo(Arithmetic.evaluate(a2),si1) < 0) {
                return fail(engine);
            }
        ...
        //END inline expansion
        return exit(engine, new PRED_$numbervars_3(a1, a2, a3, cont));
    }
}
