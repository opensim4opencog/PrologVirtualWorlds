...
/**
 ...
 @version 1.0-dmiles
*/
class PRED_$init_internal_database_1 extends PredicateBase {
    static /*Symbol*/Object s1 = makeAtom("$init");
    ...
    public PRED_$init_internal_database_1(Object a1, Predicate cont) {
        arg1 = a1;
        this.cont = cont;
    }
    ...
    public String nameUQ() { return "$init_internal_database"; }
...
default: return newIndexOutOfBoundsException("getarg", i0,null);  }   }
    ...
    public String toPrologString(java.util.Collection newParam) {
        return "'$init_internal_database'(" + argString(arg1,newParam) + ")";
    }
...
class PRED_$init_internal_database_1_1 extends PRED_$init_internal_database_1 {
    ...
    // '$init_internal_database'(A):-['$get_level'(B), '$compiled_predicate'(A, '$init', 0), call(A:'$init'), '$cut'(B)]
        ...
        return exit(engine, new PRED_$compiled_predicate_3(a1, s1, si2, p2));
    }
}
