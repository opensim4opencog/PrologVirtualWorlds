...
*/
/**
 <code>'$clause_to_term'/4</code> defined in builtins.pl<br>
 @author Mutsunori Banbara (banbara@kobe-u.ac.jp)
 @author Naoyuki Tamura (tamura@kobe-u.ac.jp)
 @author Douglas R. Miles (dmiles@users.sourceforge.net) for Object(s) 
 @version 1.0-dmiles
*/
class PRED_$clause_to_term_4 extends PredicateBase {
    ...
    public PRED_$clause_to_term_4(Object a1, Object a2, Object a3, Object a4, Predicate cont) {
        arg1 = a1;
        arg2 = a2;
        arg3 = a3;
        arg4 = a4;
...
default: return newIndexOutOfBoundsException("getarg", i0,null);  }   }
    ...
    public String toPrologString(java.util.Collection newParam) {
        return "'$clause_to_term'(" + argString(arg1,newParam) + "," + argString(arg2,newParam) + "," + argString(arg3,newParam) + "," + argString(arg4,newParam) + ")";
    }
    ...
    // '$clause_to_term'(A, B, C:D/E, F):-['$clause_to_term'(A, B, user, C, F), '$unify'(B, (G:-H)), functor(G, D, E)]
        ...
        return exit(engine, new PRED_$clause_to_term_5(a1, a2, s3, a5, a4, p2));
    }
}
