...
public class Compiler {
  /** Version information */
  public static String VERSION = "Prolog Cafe 1.1.11 (dragonfly)";
  ...
  */
  public boolean prologToJava(String prolog, String dir) {
    ...
    if (!prologToWAM(prolog, wam)) return false;
    if (!wamToJava(wam, dir)) return false;
    try {
      File f = new File(wam);
  ...
  public static void main(String argv[]) {
    try {
      ...
      Compiler comp = new Compiler();
      if (!comp.prologToJava(argv[0], ".")) System.exit(1);
      System.exit(0);
    } catch (Exception e) {
      e.printStackTrace();
      System.exit(1);
