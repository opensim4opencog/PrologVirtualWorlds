...
/**
 ...
 @version 1.0-dmiles
*/
class PRED_$parse_tokens_list_rest_3 extends PredicateBase {
    ...
    public PRED_$parse_tokens_list_rest_3(Object a1, Object a2, Object a3, Predicate cont) {
        arg1 = a1;
        arg2 = a2;
        arg3 = a3;
        this.cont = cont;
    ...
    public String nameUQ() { return "$parse_tokens_list_rest"; }
...
default: return newIndexOutOfBoundsException("getarg", i0,null);  }   }
    ...
    public String toPrologString(java.util.Collection newParam) {
        return "'$parse_tokens_list_rest'(" + argString(arg1,newParam) + "," + argString(arg2,newParam) + "," + argString(arg3,newParam) + ")";
    }
...
class PRED_$parse_tokens_list_rest_3_1 extends PRED_$parse_tokens_list_rest_3 {
    public Predicate exec(Prolog engine) { enter(engine); Object[] engine_aregs = engine.getAreg(); //anony 
    // '$parse_tokens_list_rest'(A, [ ('|')|B], C):-!, '$parse_tokens'(A, 999, B, D), '$parse_tokens_expect'(']', D, C)
        ...
        a3 = engine_aregs[3];
        cont = engine.cont;
    // '$parse_tokens_list_rest'(A, [ ('|')|B], C):-['$neck_cut', '$parse_tokens'(A, 999, B, D), '$parse_tokens_expect'(']', D, C)]
        a2 = deref( a2);
        if (isListTerm(a2)){
        ...
        p1 = new PRED_$parse_tokens_expect_3(s3, a5, a3, cont);
        return exit(engine, new PRED_$parse_tokens_4(a1, si2, a4, a5, p1));
    }
}

class PRED_$parse_tokens_list_rest_3_2 extends PRED_$parse_tokens_list_rest_3 {
    public Predicate exec(Prolog engine) { enter(engine); Object[] engine_aregs = engine.getAreg(); //anony 
    // '$parse_tokens_list_rest'([A|B], [ (',')|C], D):-!, '$parse_tokens'(A, 999, C, E), '$parse_tokens_skip_spaces'(E, F), '$parse_tokens_list_rest'(B, F, D)
        ...
        a3 = engine_aregs[3];
        cont = engine.cont;
    // '$parse_tokens_list_rest'([A|B], [ (',')|C], D):-['$neck_cut', '$parse_tokens'(A, 999, C, E), '$parse_tokens_skip_spaces'(E, F), '$parse_tokens_list_rest'(B, F, D)]
        a1 = deref( a1);
        if (isListTerm(a1)){
        ...
        p1 = new PRED_$parse_tokens_list_rest_3(a5, a8, a3, cont);
        p2 = new PRED_$parse_tokens_skip_spaces_2(a7, a8, p1);
        return exit(engine, new PRED_$parse_tokens_4(a4, si2, a6, a7, p2));
    }
}
...
class PRED_$parse_tokens_list_rest_3_3 extends PRED_$parse_tokens_list_rest_3 {
    ...
    // '$parse_tokens_list_rest'([], A, B):-['$parse_tokens_expect'(']', A, B)]
        ...
        return exit(engine, new PRED_$parse_tokens_expect_3(s3, a2, a3, cont));
    }
}
