...
public class PrologMain {
	...
	try {
	    ...
	    arg1 = Prolog.makeList(Prolog.makeSymbol("user"), arg1);
	    arg1 = Prolog.makeList(Prolog.makeSymbol("jp.ac.kobe_u.cs.prolog.builtin"), arg1);
	...
	if (i == 1) {
	    Object[] args = {Prolog.makeSymbol("user"), 
			   Prolog.makeSymbol(st.nextToken())};
	    return Prolog.makeStructure(Prolog.makeSymbol(":", 2), args);
	} else if (i == 2) {
	    Object[] args = {Prolog.makeSymbol(st.nextToken()), 
			   Prolog.makeSymbol(st.nextToken())};
	    return Prolog.makeStructure(Prolog.makeSymbol(":", 2), args);
	} else {
	    return null;
