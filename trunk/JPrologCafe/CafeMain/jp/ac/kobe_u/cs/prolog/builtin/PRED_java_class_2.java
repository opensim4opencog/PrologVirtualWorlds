/* PRED_java_class_2 - at Sun Jul 13 19:55:44 PDT 2008 */
...
public class PRED_java_class_2 extends JavaPredicate {
  /**
   *
   */
  ...
  public PRED_java_class_2() {
    /* flow_0_0_EmptyBlock_1852833748
    */
    /* empty */}

  public PRED_java_class_2(Object term, Object term_0_, Predicate predicate) {
  ...
  public Predicate exec(Prolog prolog) {
    ...
    */
    ...
    if (!unify(term_1_, makeJavaObject(toJava(term).getClass()))) return prolog.fail();
    return this.cont;
  }
  ...
  public String toPrologString(Collection newParam) {
    ...
    */
    return "java_class(" + this.arg1 + "," + this.arg2 + ")";
  }
}
