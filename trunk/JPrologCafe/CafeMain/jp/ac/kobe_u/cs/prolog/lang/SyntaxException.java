...
public class SyntaxException extends BuiltinException {
    ...
    public static /*SymbolTerm*/Object SYNTAX_ERROR = StaticProlog.makeAtom("syntax_error", 5);
    ...
    public SyntaxException(String _type, Object _culprit, String _message) {
	type       = _type;
	culprit    = _culprit;
	message    = _message;
    }
    ...
    public SyntaxException(Predicate _goal, int _argNo, String _type, Object _culprit, String _message) {
	this.goal  = _goal;
	this.argNo = _argNo;
	type       = _type;
	culprit    = _culprit;
