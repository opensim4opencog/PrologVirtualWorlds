...
public class Help {
   ...
   private String body;
      public String getAgentGeneric() { return body; }
      public void setAgentGeneric(String body) { this.body = body; }
   ...
   public static Help loadHelp(XMLElement xml) throws Exception {
      ...
      if(src == null) {
         ...
         for(Enumeration enum = xml.enumerateChildren(); enum.hasMoreElements(); ) {
            ...
            else if(nom.equals(PROPERTY_COMMENT)) {
               h.title = nxt.getAttribute(PROPERTY_PRETTYNAME);
