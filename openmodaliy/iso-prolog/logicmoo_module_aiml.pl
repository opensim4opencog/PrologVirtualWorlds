...
computeAnswer(Votes,String,Atom,Votes):-is_string(String),to_codes(String,Codes),!,atom_codes(Atom,Codes).
computeAnswer(Votes,'$stringCodes'(List),AA,Votes):-!,atom_codes(AA,List).
