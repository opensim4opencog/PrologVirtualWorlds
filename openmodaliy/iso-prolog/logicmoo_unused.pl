...
% ======================================================
/*
agentRequest(KIFCharsIn,FmlInOpen,Vars,Ctx,Context,Agent,UResultsSoFar,Result,ExplainationOut,Status):-
	...
	assert(mooDatabase('<=>'(FmlInOpen,RequestPrototype),CAN,Flags,Vars,Context,TN,Agent,on)),
	...
	agentRequestEach(UFmlInOpen,URequest,UChaseVars,Ctx,Context,Agent,UResultsSoFar,Result,Explaination,Status),
...
agentBelief(FmlInOpen,Literal,VarsRequested,Ctx,Context,Agent,UA, UVars,[All|Explaination],done(true:UA)):- 
...
agentBelief(FmlInOpen,NLiteral,VarsRequested,Ctx,Context,Agent,UA, UVars,[All|Explaination],done(false:UA)):- 
	NLiteral=..[F|Args],
...
mooCache('~subclass'(v('Abstract', A, ['Class'|B]), v('Abstract', 'Entity', ['Class'|C])), guard([A, B, C], [D, E, F], '~instance'(v('Abstract', D, ['Class'|E]), v('Abstract', 'Class', ['Class', 'Abstract', 'Class'|G])), 4, ['CLASS'=D], [D], [], [], [], [D], '~subclass'(v('Abstract', D, ['Class'|E]), v('Abstract', 'Entity', ['Class'|F]))), not(subclass), 'LogicMOO', 'BASE ONTOLOGY', 637).
mooCache(instance(v('Abstract', A, ['Class'|B]), v('Abstract', 'Class', ['Class', 'Abstract', 'Class'|C])), guard([A, B, C], [D, E, F], subclass(v('Abstract', D, ['Class'|E]), v('Abstract', 'Entity', ['Class'|G])), 3, ['CLASS'=D], [D], [], [], [], [D], instance(v('Abstract', D, ['Class'|E]), v('Abstract', 'Class', ['Class', 'Abstract', 'Class'|F]))), instance, 'LogicMOO', 'BASE ONTOLOGY', 637).
mooCache('~instance'(v('Abstract', A, ['Class'|B]), v('Abstract', 'Class', ['Class', 'Abstract', 'Class'|C])), guard([A, B, C], [D, E, F], '~subclass'(v('Abstract', D, ['Class'|E]), v('Abstract', 'Entity', ['Class'|G])), 2, ['CLASS'=D], [D], [], [], [], [D], '~instance'(v('Abstract', D, ['Class'|E]), v('Abstract', 'Class', ['Class', 'Abstract', 'Class'|F]))), not(instance), 'LogicMOO', 'BASE ONTOLOGY', 637).
mooCache('~subclass'(v('Abstract', A, ['Class'|B]), v('Abstract', 'Entity', ['Class'|C])), guard([A, B, C], [D, E, F], '~instance'(v('Abstract', D, ['Class'|E]), v('Abstract', 'Class', ['Class', 'Abstract', 'Class'|G])), 4, ['CLASS'=D], [D], [], [], [], [D], '~subclass'(v('Abstract', D, ['Class'|E]), v('Abstract', 'Entity', ['Class'|F]))), not(subclass), 'LogicMOO', 'BASE ONTOLOGY', 637).
mooCache(instance(v('Abstract', A, ['Class'|B]), v('Abstract', 'Class', ['Class', 'Abstract', 'Class'|C])), guard([A, B, C], [D, E, F], subclass(v('Abstract', D, ['Class'|E]), v('Abstract', 'Entity', ['Class'|G])), 3, ['CLASS'=D], [D], [], [], [], [D], instance(v('Abstract', D, ['Class'|E]), v('Abstract', 'Class', ['Class', 'Abstract', 'Class'|F]))), instance, 'LogicMOO', 'BASE ONTOLOGY', 637).
mooCache('~instance'(v('Abstract', A, ['Class'|B]), v('Abstract', 'Class', ['Class', 'Abstract', 'Class'|C])), guard([A, B, C], [D, E, F], '~subclass'(v('Abstract', D, ['Class'|E]), v('Abstract', 'Entity', ['Class'|G])), 2, ['CLASS'=D], [D], [], [], [], [D], '~instance'(v('Abstract', D, ['Class'|E]), v('Abstract', 'Class', ['Class', 'Abstract', 'Class'|F]))), not(instance), 'LogicMOO', 'BASE ONTOLOGY', 637).
...
% Positive Request       
agentRequestEach(FmlInOpen,URequest,UVars,Ctx,Context,Agent,UA, UVars,bullet(FmlInOpen) * Explaination,Result):-
	set_quit_time(1.1),
	writeDebug(green,'Stage 3 - Positive ':FmlInOpen ),
	pre_deduce_true(Context,Ctx),
...
% Negative Request       
agentRequestEach(FmlInOpen,URequest,UVars,Ctx,Context,Agent,UA2,['Result'='false'],Explaination,done(false:FmlInOpen:Explaination)):-%true,
	...
	pre_deduce_false(Context,Ctx),
        (getMooOption(Agent,opt_backchains_max_neg=BackchainsMax)),
...
%mooCache(instance('exists '([63, 67, 79, 76, 79, 82, 50], exists([63, 67, 79, 76, 79, 82, 49], exists([63, 80, 65, 82, 84, 50], exists([63, 80, 65, 82, 84, 49], and(superficialPart([63, 80, 65, 82, 84, 49], A), and(superficialPart([63, 80, 65, 82, 84, 50], A), and(attribute([63, 80, 65, 82, 84, 49], [63, 67, 79, 76, 79, 82, 49]), and(attribute([63, 80, 65, 82, 84, 50], [63, 67, 79, 76, 79, 82, 50]), and(instance([63, 67, 79, 76, 79, 82, 49], 'ColorProperty'), and(instance([63, 67, 79, 76, 79, 82, 50], 'ColorProperty'), not(equal([63, 67, 79, 76, 79, 82, 49], [63, 67, 79, 76, 79, 82, 50])))))))))))), 'ColorProperty'), +instance(+, +), [attribute(A, 'Polychromatic'), domainV(A, [:(attribute, 1), :(superficialPart, 2)])], [+attribute(-, +)], 2, 'LogicMOO', 'QUALITIES', surf('LogicMOO', 6917, 12, ['OBJ'=A, 'PART1'=B, 'PART2'=C, 'COLOR1'=D, 'COLOR2'=E|F])).
...
Quine, W. V. O., "Reference and Modality", in Agent a Logical Point of View, Cambridge, MA: Harvard University Press, 1953: 139-159 
...
onpropertychanged(Agent,"GeometryName",101,Skin):-new_fact(is_object(Agent)),new_fact(object_desc(Agent,Skin)).

onpropertychanged(Agent,"Geometry",0,Skin):-new_fact(is_object(Agent)),new_fact(object_desc(Agent,Skin)).


onpropertychanged(Agent,"Profile",0,ProfilePart):-new_fact(is_object(Agent)),new_fact(is_property(ProfilePart)),
                        new_fact(has_part(Agent,ProfilePart) ).
...
onuievent(action(Room,_,[Agent,Me],Text)):-append(_,"approaches you.",Text),
                new_fact(is_place(Room)),
                new_fact(is_object(Agent)),new_fact(is_actor(Agent)),
                new_fact(is_object(Me)),new_fact(is_actor(Me)),
                new_event(approach(Agent,Me)).

onuievent(say(Room,Agent,Text)):-
                new_fact(is_place(Room)),
                new_fact(is_object(Agent)),new_fact(is_actor(Agent)),
                new_event(say(Room,Agent,Text)).


onpropertychanged(_,"Profile",1,"Ignoring"):-ignore.

onuievent(ignoredbyuser(Target,Agent)):-
                new_fact(is_object(Target)),new_fact(is_actor(Target)),
                new_fact(is_object(Agent)),new_fact(is_actor(Agent)),
                new_event(ignored(Target,Agent)).
...
% ===================================================================
% krlog_to_prorequest(KRProlog,Prolog)  Converts And/Or/Implies terms to Proper Prolog
% ====================================================================

krlog_to_prorequest(A,A):-isSlot(A),!.

krlog_to_prorequest(ThisKR,That):-
...
C:\jdk1.3\jre\lib;
C:\jdk1.3\lib;
C:\jakarta-tomcat\webapps\moo\WEB-INF\lib\xerces.jar;
C:\jakarta-tomcat\webapps\moo\WEB-INF\lib\jakarta-regexp-1.2.jar;
C:\jakarta-tomcat\webapps\moo\WEB-INF\lib\cpj.jar;C:\jakarta-tomcat\lib\jasper.jar;C:\jakarta-tomcat\lib\webserver.jar;C:\jakarta-tomcat\lib\servlet.jar;C:\jakarta-tomcat\webapps\moo\WEB-INF\classes;C:\jdk1.3\src.jar
...
% if ``exact'' flag is set then only check explaination for examples
...
merge_vlist([],[]).
merge_vlist([V/L|T],PrologMOOd):-
        delete1(V/L1,T,T1), !,
        append(L1,L,L2),
        merge_vlist([V/L2|T1],PrologMOOd).
merge_vlist([V/L|T],[V/L|PrologMOOd]):-
        merge_vlist(T,PrologMOOd).
...
Parsing STANDARD/KIF Chars to a Prolog Term: 'Assertionpterm' placing variables in 'ClauseVariables'
...
cmd_proc([new,'Consultation','Relation',RelationName,SARGMODES],'GlobalContext',_TN,Vars):-!,
                     tell_sterm_rev('GlobalContext',['surface-instance',RelationName,'Relation'],_TN,Vars),
                     sterm_to_pterm([list|SARGMODES],PARGMODES),
                     length(PARGMODES,Valence),
                     tell_sterm_rev('GlobalContext',[valence,RelationName,Valence],_TN,Vars),

                     length(ARGS,Valence),
                     tell_sterm_rev('GlobalContext',[=>,[consultation,RelationName,PARGMODES,ARGS],[RelationName|ARGS]],_TN,Vars).
...
STerm: is any format in KIF/STANDARD/Prolog
...
tell_sterm(STerm,Ctx,TN,Context,CM,Vars):- abolish_all_tables,
            ...
            getMooOption(Agent,opt_theory,DContext), !,  %supplies default Context
...
cmd_proc([remove,scenario]):-
            retractall(moo_K_scenario(_Cxt,_MooView)),
            sendNote(user,logicEngine,'Insightfull information',['moo_K_scenario cleared']).

cmd_proc([show,scenario]):-
            findall(moo_K_scenario(_Cxt,_Request_Compiled,_MooView,_ResultSingle_bindings,_OtherTruth,_How),
                    (moo_K_scenario(_Cxt,_Request_Compiled,_MooView,_ResultSingle_bindings,_OtherTruth,_How),
                     sendNote(user,logicEngine,'Insightfull information',moo_K_scenario(_Cxt,_Request_Compiled,_MooView,_ResultSingle_bindings,_OtherTruth,_How))),
                        _).
...
cmd_proc([halt],_,_,_):-
               sendNote(user,logicEngine,'Insightfull information','Halting Moo Logic Engine'),
               halt.
...
cmd_proc(['read-file',FileName],_,_,_):-   !,
               cmd_proc(['read-file',FileName,'GlobalContext']).


cmd_proc(['read-file',FileName,Ctx],_,_,_):-!,
               once((
                     isMooOption(Agent,opt_language=Opt_language),
                     isMooOption(Agent,opt_precompiled=Opt_precompiled),
                     isMooOption(Agent,opt_theory=Opt_theory),
                     isMooOption(Agent,opt_compiler=Opt_compiler),
                     isMooOption(Agent,opt_notation=Opt_notation)
               )),
...
% ===================================================================
%  deduceSurface_actual Predicates detect and handle potential cyclic logic by only producing GAFS
...
%:- table deduceSurface_actual/2.
%:- table deduceSurface_actual/3.
%:- table deduceSurface/2.

%:-auto_table.

%:-suppl_table.

deduceSurface_false(_Context_atom,[false],[false]).
%deduceSurface_false(_Context_atom,GAF,Explaination):-not_deduceSurface(_Context_atom,GAF,Explaination).
deduceSurface_false(_Context_atom,[not,GAF],[not,GAF]):-deduceSurface(_Context_atom,GAF).

deduceSurface(_Context_atom,[PredicateI|Args]):-deduceSurface(_Context_atom,[PredicateI|Args],_).

deduceSurface(_Context_atom,[true],[true]).
deduceSurface(_Context_atom,[not,[not,true]],[true]).
/*
deduceSurface(_Context_atom,[and,Gaf1,Gaf2],[and,Explaination1,Explaination2]):-
                  deduceSurface(_Context_atom,Gaf1,Explaination1),
                  deduceSurface(_Context_atom,Gaf2,Explaination2).
deduceSurface(_Context_atom,[or,Gaf1,_Gaf2],[or,Explaination1,nottried]):-
                  deduceSurface(_Context_atom,Gaf1,Explaination1).
deduceSurface(_Context_atom,[or,_Gaf1,Gaf2],[or,failed,Explaination2]):-
                  deduceSurface(_Context_atom,Gaf2,Explaination2).

 */

deduceSurface(_Context_atom,[PredicateI|Args],[resource,[PredicateI|Args]]):-
               resource(_Context_atom,[PredicateI|Args]).

deduceSurface(_Context_atom,[PredicateI|Args],[Explaination,[PredicateI|Args]]):-
                 ignore((
                        isMooOption(Agent,cb_consultation = true),
                        consultation(_Context_atom,[PredicateI|Args]),
                        Explaination=consultation)),

                 deduceSurface_actual(_Context_atom,[PredicateI|Args],Explaination).
...
not_deduceSurface(_Context_atom,GAF,[not,GAF]):-possible_chain(_Context_atom,GAF),nonvar(_Context_atom),provenot(deduceSurface(_Context_atom,GAF,GAF)).
...
possible_chain(_Context_atom,[Pred|ArgS]):-
            deduceSurface(_Context_atom,[subsumed_relation,Alias,Pred]),
            possible_chain_actual(_Context_atom,[Alias|ArgS]).

possible_chain_actual(_Context_atom,[Pred,Arg1]):-
            deduceSurface(_Context_atom,[functsymbol,Pred,1]),
            moo_D_nth_domain_check(_Context_atom,Pred,1,Arg1).

possible_chain_actual(_Context_atom,[Pred,Arg1,Arg2]):-
            deduceSurface(_Context_atom,[functsymbol,Pred,2]),
            moo_D_nth_domain_check(_Context_atom,Pred,1,Arg1),
            moo_D_nth_domain_check(_Context_atom,Pred,2,Arg2).

possible_chain_actual(_Context_atom,[Pred,Arg1,Arg2,Arg3]):-
            deduceSurface(_Context_atom,[functsymbol,Pred,3]),
            moo_D_nth_domain_check(_Context_atom,Pred,1,Arg1),
            moo_D_nth_domain_check(_Context_atom,Pred,2,Arg2),
            moo_D_nth_domain_check(_Context_atom,Pred,3,Arg3).

possible_chain_actual(_Context_atom,[Pred,Arg1,Arg2,Arg3,Arg4]):-
            deduceSurface(_Context_atom,[functsymbol,Pred,4]),
            moo_D_nth_domain_check(_Context_atom,Pred,1,Arg1),
            moo_D_nth_domain_check(_Context_atom,Pred,2,Arg2),
            moo_D_nth_domain_check(_Context_atom,Pred,3,Arg3),
            moo_D_nth_domain_check(_Context_atom,Pred,4,Arg4).


possible_chain_actual(_Context_atom,[Pred,Arg1,Arg2,Arg3,Arg4,Arg5]):-
            deduceSurface(_Context_atom,[functsymbol,Pred,5]),
            moo_D_nth_domain_check(_Context_atom,Pred,1,Arg1),
            moo_D_nth_domain_check(_Context_atom,Pred,2,Arg2),
            moo_D_nth_domain_check(_Context_atom,Pred,3,Arg3),
            moo_D_nth_domain_check(_Context_atom,Pred,4,Arg4),
            moo_D_nth_domain_check(_Context_atom,Pred,5,Arg5).

possible_chain_actual(_Context_atom,[Pred,Arg1,Arg2,Arg3,Arg4,Arg5,Arg6]):-
            deduceSurface(_Context_atom,[functsymbol,Pred,6]),
            moo_D_nth_domain_check(_Context_atom,Pred,1,Arg1),
            moo_D_nth_domain_check(_Context_atom,Pred,2,Arg2),
            moo_D_nth_domain_check(_Context_atom,Pred,3,Arg3),
            moo_D_nth_domain_check(_Context_atom,Pred,4,Arg4),
            moo_D_nth_domain_check(_Context_atom,Pred,5,Arg5),
            moo_D_nth_domain_check(_Context_atom,Pred,6,Arg6).
...
not_backwards_chain(_Context_atom,Consequent,[and,FormulaA,FormulaB]) :- backwards_chain(_Context_atom,Consequent,[and,FormulaA,FormulaB]),
                  (not_deduceSurface(_Context_atom,FormulaA);not_deduceSurface(_Context_atom,FormulaB)).
...
not_backwards_chain(_Context_atom,Consequent,Antecedant) :- backwards_chain(_Context_atom,Consequent,Antecedant),
                   not_deduceSurface(_Context_atom,Antecedant).
...
%moo_invoke_obj(_Context_atom,FormulaA):-nonvar(FormulaA), is_list(FormulaA),!,prove(_Context_atom,FormulaA,10,tabled_true,_,_).

%moo_invoke_obj(_Context_atom,FormulaA):-nonvar(FormulaA), (deduceSurface_actual(_Context_atom,FormulaA) ; (functor(FormulaA,F,AA),system(F/AA),call(FormulaA)) ).

eval(_Context_atom,FormulaA) :- once(moo_invoke_obj(_Context_atom,FormulaA)).
...
%:-auto_table.
%====================================================================
% moo_I_deduce(Context_atom(I),Fact(I),Depth(I),Truth(O),Explaination(O)(I))
%====================================================================

%% :-table moo_I_deduce/5.

%%moo_I_deduce(_Context_atom,_FormulaA,_Depth,_lost,toofar) :- request_done,!,fail.   %Have the limits been reached?
moo_I_deduce(_Context_atom,VAR,_Depth,_Result,var(VAR)) :- var(VAR).
moo_I_deduce(_Context_atom,[!],_Depth,tabled_true,fact).
moo_I_deduce(_Context_atom,_FormulaA,_Depth,lost,toofar) :- _Depth<1.

moo_I_deduce(_Context_atom,Antecedants,D1,Truth,Explaination):-
              moo_I_deduce_no_backchain(_Context_atom,Antecedants,D1,Truth,Explaination).

moo_I_deduce(_Context_atom,[G|AF],_Depth,_Result, (FC '=>' Explaination '=>' Antecedants '=>' [G|AF])) :-nonvar(G),
              deduceSurface(_Context_atom,[=>,Antecedants,[G|AF]],FC),
               D1 is _Depth-1,
              (contained_in_formula([G|AF],Antecedants) ->
              moo_I_deduce_no_backchain(_Context_atom,Antecedants,D1,_Result,Explaination)
               ;
             moo_I_deduce(_Context_atom,Antecedants,D1,_Result,Explaination)
              ),assert(_Context_atom,[G|AF]).

/*
% Supports Cut Version TODO
moo_I_deduce(_Context_atom,FormulaA,_Depth,_Result,(Explaination '=>' FormulaA)) :-
     backwards_chain(_Context_atom,FormulaA,FormulaB),_Depth1 is D-1,
     detec!(FormulaB,B1,B2,Cut),
     (Cut = tabled_true,moo_I_deduce(_Context_atom,B1,_Depth1,R1,Explaination1),
        (R1 \= tabled_true,_Result = R1,return_explaination(_Context_atom,Explaination1,B2,Explaination);
         R1 = tabled_true,!,moo_I_deduce(_Context_atom,B2,_Depth1,_Result,Explaination2),
                    conjunct(Explaination1,Explaination2,Explaination));
      Cut = not_proved,moo_I_deduce(_Context_atom,FormulaB,_Depth1,_Result,Explaination)).
...
%% :-table moo_I_deduce_no_backchain/5.


moo_I_deduce_no_backchain(_Context_atom,[P|Args],_Depth,Truth,Explaination) :-
         moo_I_deduce_no_backchain_tf(_Context_atom,[P|Args],_Depth,Truth,Explaination).

moo_I_deduce_no_backchain(_Context_atom,[P|Args],_Depth,_Result,Explaination) :- nonvar(P),
         moo_I_deduce_nonvar(_Context_atom,[P|Args],_Depth,_Result,Explaination).


moo_I_deduce_no_backchain_tf(_Context_atom,[P|Args],_D,tabled_false,Explaination):-nonvar(P),deduceSurface_false(_Context_atom,[P|Args],Explaination).

moo_I_deduce_no_backchain_tf(_Context_atom,[P|Args],_D,tabled_true,Explaination):-deduceSurface(_Context_atom,[P|Args],Explaination),not(deduceSurface_false(_Context_atom,[P|Args],_Explaination)).



%moo_I_deduce(_Context_atom,C,_D,not_proved,unprovable(C) ).

%====================================================================
% moo_I_deduce_nonvar(Context_atom(I),Fact(I),Depth(I),Truth(O),Explaination(O)(I))
%====================================================================

%% :-table moo_I_deduce_nonvar/6.

%and

moo_I_deduce_nonvar(_Context_atom,[and,FormulaA,FormulaB],_Depth,_Result,[and,ExplainationA,ExplainationB]) :-
   D1 is _Depth-1, D1>0,
     moo_I_deduce(_Context_atom,FormulaA,D1,_Result,ExplainationA),
     moo_I_deduce(_Context_atom,FormulaB,D1,_Result,ExplainationB).

% or

moo_I_deduce_nonvar(_Context_atom,[or,FormulaA,FormulaB],_Depth,_Result,([or,ExplainationA,FormulaB])) :-
   D1 is _Depth-1, D1>3, moo_I_deduce(_Context_atom,FormulaA,D1,_Result,ExplainationA).

moo_I_deduce_nonvar(_Context_atom,[or,FormulaA,FormulaB],_Depth,_Result,(ExplainationB '=>' [or,FormulaA,ExplainationB])) :-
   D1 is _Depth-1, D1>3, moo_I_deduce(_Context_atom,FormulaB,D1,_Result,ExplainationB).

/*
% AND/2   !
moo_I_deduce_nonvar(_Context_atom,[and,FormulaA,FormulaB],_Depth,_Result,[and,ExplainationA,ExplainationB]) :-
   D1 is _Depth-1, D1>3,
     moo_I_deduce_nonvar(_Context_atom,FormulaA,_Depth,_ResultA,ExplainationA),
     prove_conj(_Context_atom,_ResultA,FormulaB,_Depth,_Result,ExplainationB).

prove_conj(_Context_atom,tabled_true,FormulaB,_Depth,_Result,Explaination) :- !,moo_I_deduce_nonvar(_Context_atom,FormulaB,_Depth,_Result,Explaination).
         %      prove_conj(_Context_atom,RA, FormulaB,_Depth,RA,FormulaB:nottried).
*/

% XOR/2    !
moo_I_deduce_nonvar(_Context_atom,[xor,FormulaA,FormulaB],_Depth,_Result,[xor,Explaination1,[not,Explaination2]]) :- !,
     (moo_I_deduce_nonvar(_Context_atom,FormulaA,_Depth,tabled_true,Explaination1),provenot(moo_I_deduce_nonvar(_Context_atom,FormulaB,_Depth,tabled_true,Explaination2)))
   ;
     (moo_I_deduce_nonvar(_Context_atom,FormulaB,_Depth,tabled_true,Explaination1),provenot(moo_I_deduce_nonvar(_Context_atom,FormulaA,_Depth,tabled_true,Explaination2))).


%Not

moo_I_deduce_nonvar(_Context_atom,[not,FormulaA],_Depth,tabled_true,[not,Explaination]) :-
              (moo_I_deduce(_Context_atom,FormulaA,_Depth,Result,Explaination)),(Result \= tabled_true).

moo_I_deduce_nonvar(_Context_atom,[not,FormulaA],_Depth,tabled_false,[not,Explaination]) :-
              (moo_I_deduce(_Context_atom,FormulaA,_Depth,Result,Explaination)),(Result \= tabled_false).

moo_I_deduce_nonvar(_Context_atom,[not,FormulaA],_Depth,not_tn,[not,Explaination]) :-nonvar(FormulaA),
              (moo_I_deduce(_Context_atom,FormulaA,_Depth,Result,Explaination)),member(Result,[tabled_false,tabled_true]).

%Non
moo_I_deduce_nonvar(_Context_atom,[not,GAF],_Depth,tabled_true,Explaination) :-
               not_deduceSurface(_Context_atom,GAF,Explaination).


% No/None/1     !
%moo_I_agreggate(_Context_atom,[no,X,[Pred|ArgS]],_Depth,_Result,([not,[Pred|ArgS]] '=>' _Result)) :-
%     (not_deduceSurface(_Context_atom,[Pred|ArgS]),_Result = tabled_true); _Result = not_proved.



% subrequest-ist/2
moo_I_deduce_nonvar(_Context_atom,[dbi,OtherContext_atom,Prop],_Depth,_Result,[subrequest,OtherContext_atom,Explaination]) :-
               moo_I_deduce(OtherContext_atom,Prop,_Depth,_Result,(Explaination)).

% =/2     !
moo_I_deduce_nonvar(_Context_atom,[Same,FormulaA,FormulaB],_Depth,tabled_true,(FormulaA=FormulaB)):-
...
moo_I_deduce_nonvar(_Context_atom,[member,E,Set],_Depth,tabled_true,( Explaination )) :-
                  deduceSurface(_Context_atom,['surface-instance',E,Set],Explaination).
...
% is
moo_I_deduce_nonvar(_Context_atom,[is,Result,SMath],_D,tabled_true,[is,Result,SMath]) :-
            ground(SMath), math_sterm_to_pterm(SMath,Math),
              call(Result is Math).      math_sterm_to_pterm(SMath,Math):-sterm_to_pterm(SMath,Math).

% intersect/3
moo_I_deduce_nonvar(_Context_atom,[intersector,Class1,Class2,Instance],_Depth,tabled_true,[=>,[and,Explaination1,Explaination2],[intersect,Class1,Class2,Instance]]) :-
               (nonvar(Class1);nonvar(Class2)),
               moo_I_deduce_nonvar(_Context_atom,[member,Instance,Class1],_Depth,_Result,Explaination1),
               moo_I_deduce_nonvar(_Context_atom,[member,Instance,Class2],_Depth,_Result,Explaination2).

% stack_inspection/1
moo_I_deduce_nonvar(_Context_atom,[current_context,_Context_atom],_,tabled_true,[current_context,_Context_atom]) :- !.
moo_I_deduce_nonvar(_Context_atom,[current_settings],_,tabled_true,[current_settings]) :- !.
moo_I_deduce_nonvar(_Context_atom,[current_depth,Current_Depth],Current_Depth,tabled_true,[current_depth,Current_Depth]) :- !.

% Disjoint
moo_I_deduce_nonvar(_Context_atom,[disjoint,C1,C2],_D,tabled_true,(no_shared_'instance's(C1,C2))):-ground([disjoint,C1,C2]),
                              bagof(Entity,
                                    ((
                                      deduceSurface_specialized(_Context_atom,['surface-instance',Entity,C1]),
                                      deduceSurface_specialized(_Context_atom,['surface-instance',Entity,C2])
                                      )),SE),SE=[].


% Conjoint/3
moo_I_deduce_nonvar(_Context_atom,[conjoint,C1,C2,Num],_D,tabled_true,(shared_'instance's(C1,C2))):-
                              bagof(Entity,
                                    ((deduceSurface_specialized(_Context_atom,['surface-instance',Entity,C1]),
                                                deduceSurface_specialized(_Context_atom,['surface-instance',Entity,C2]))),Num).

% Conjoint/2
moo_I_deduce_nonvar(_Context_atom,[conjoint,C1,C2],_D,tabled_true,(shared_'instance's(C1,C2))):-
                                    ((deduceSurface_specialized(_Context_atom,['surface-instance',Entity,C1]),
                                                deduceSurface_specialized(_Context_atom,['surface-instance',Entity,C2]))).

%or(X,Y):-moo_invoke_obj(_C,X);moo_invoke_obj(_C,Y).

% command
moo_I_deduce_nonvar(_Context_atom,[exec,COMMAND],_Depth,tabled_true,command) :- cmd(COMMAND).

% prolog
moo_I_deduce_nonvar(_Context_atom,[F|ARGS],_Depth,_Result,[macro_script,[F|ARGS]],_Result) :-length(ARGS,N),
            (system(F/N)),(sterm_to_pterm([F|ARGS],PTERM),call(PTERM),_Result = tabled_true; _Result = not_proved).


moo_I_deduce_nonvar(_Context_atom,[thereExists,Entity,Facts],D,tabled_true, (Explaination)) :-
                  (handle_skolem_explaination(_Context_atom,[thereExists,Entity,Facts],D,tabled_true, (Explaination))).

% Conclusion
%moo_I_deduce_nonvar(_Context_atom,[Pred,P|Args],_Depth,_Result, Explaination) :- nonvar(P),
%                moo_I_conclusion(_Context_atom,[Pred,P|Args],_Depth,_Result, Explaination).

% Agreggation
moo_I_deduce_nonvar(_Context_atom,[Pred,X|[P|Args]],_Depth,_Result, Explaination) :- nonvar(P),
                 moo_I_agreggate(_Context_atom,[Pred,X|[P|Args]],_Depth,_Result, Explaination).



%SKOLEMIZATION and thereExists
handle_skolem_explaination(_Context_atom,Consequent1,D,Truth, Explaination):-
    %     sendNote(debug,logicEngine,'Debug Info',handle_skolem_explaination(_Context_atom,Consequent1,D,Truth, Explaination)),
         handle_skolem_explaination1(_Context_atom,Consequent1,D,Truth, Explaination).
     %    sendNote(debug,logicEngine,'Debug Info',handle_skolem_explaination_returned(_Context_atom,Consequent1,D,Truth, Explaination)).

handle_skolem_explaination1(_Context_atom,[thereExists,_SkolemedEntity,Formula],D,tabled_true, (Explaination '=>' [thereExists,_SkolemedEntity,Formula])) :-
      moo_I_deduce(_Context_atom,Formula,D,tabled_true,Explaination),
      moo_I_deduce_nonvar(_Context_atom,[skolemize,_SkolemedEntity],D,tabled_true,SKOLEMEXPLAINATION),
      (moo_A_do_assert_list(_Context_atom,skolemized(SKOLEMEXPLAINATION),[[thereExists,_SkolemedEntity,Formula]])),
      (moo_A_do_assert_list(_Context_atom,skolemized(SKOLEMEXPLAINATION),[Formula])),
      (moo_A_do_assert_list(_Context_atom,skolemized(SKOLEMEXPLAINATION),[[skolemize,_SkolemedEntity]])).
...
handle_skolem_explaination1(_Context_atom,Consequent1,D,tabled_true, (Explaination '=>' SKOLEMEXPLAINATION '=>' asserted(Consequent1) '=>'asserted(Consequent2))) :-
      ...
      (moo_A_do_assert_list(_Context_atom,skolemized(SKOLEMEXPLAINATION),Consequent2)).
...
% Meta-Recursion
moo_I_agreggate(_Context_atom,[moo_I_deduce_nonvar,_Context_atom,FormulaA,Current_Depth,_Result,Explaination],Current_Depth,_Result,[moo_I_deduce_nonvar,_Context_atom,FormulaA,Current_Depthepth,_Result,Explaination]) :- !,
            moo_I_deduce(_Context_atom,FormulaA,Current_Depthepth,_Result,Explaination).


% subrequest-ist/2
moo_I_agreggate(_Context_atom,[subrequest,OtherContext_atom,Prop],_Depth,_Result,[subrequest,OtherContext_atom,Explaination]) :-
               moo_I_deduce(OtherContext_atom,Prop,_Depth,_Result,(Explaination)).

% forall
moo_I_agreggate(_Context_atom,[Forall,X,G],_Depth,Result,[and|ListExplaination]) :- (member(Forall,[forall,forAll,findall])),!,
                  findall([thereExists,X,Explaination],moo_I_deduce(_Context_atom,G,_Depth,Result,Explaination),ListExplaination).


% forAll/2   !
moo_I_agreggate(_Context_atom,[forAll,L,G],_Depth,_Result,(forAll(L,G) '=>' _Result)) :-
      (forAll(_Context_atom,L,G),_Result = tabled_true; _Result = not_proved).
%forAll(_Context_atom,L,G) :- copy_term((L,G),(L1,G1)), L = L1,moo_invoke_obj(_Context_atom,G1),not(not(_Context_atom,G)).

% forAll/3    !
moo_I_agreggate(_Context_atom,[forAll,G],_Depth,_Result,(forAll(G) '=>' _Result)) :-
     (forAll(_Context_atom,G),_Result = tabled_true; _Result = not_proved).
%forAll(_Context_atom,G)  :-  G \= (_,_), provenot(not(_Context_atom,G)).

%not(_Context_atom,FormulaA) :- nonvar(FormulaA),FormulaA=[not,FormulaB],moo_invoke_obj(_Context_atom,FormulaB).
%not(_Context_atom,[Pred|ArgS]) :- not_deduceSurface(_Context_atom,[Pred|ArgS]).
%not(_Context_atom,FormulaA) :- nonvar(FormulaA),functor(FormulaA,F,AA),system(F/_),not(FormulaA).

%setof

moo_I_agreggate(_Context_atom,[setof,X,G,L],_Depth,_Result,( Explaination '=>' setof(X,G,L) )) :-
     setof(p(X,_Depth,R,P),moo_I_deduce_nonvar(_Context_atom,G,_Depth,R,P),ListExplaination),
     filter_explaination(_Context_atom,ListExplaination,_Result,L,Explaination).

      filter_explaination(_Context_atom,[p(_X,_Depth,not_proved,P)],not_proved,[],seprovenull(P)).

            filter_explaination(_Context_atom,ListExplaination,tabled_true,L,setfull(LExplaination)) :-
                 filter(_Context_atom,ListExplaination,[],L,LExplaination).

            filter(_Context_atom,[],_,[],[]).
            filter(_Context_atom,[p(X,_,R,_)|Rest],L1,L,LExplaination) :-
                 (R = not_proved; member(X,L1)),!,filter(_Context_atom,Rest,L1,L,LExplaination).
...
moo_I_conclusion(_Context_atom,[backwards_chain,true,Cons,Antec],_Depth,tabled_true,(Antec'=>'Cons)) :- backwards_chain(_Context_atom,Cons,Antec).
...
moo_I_conclusion(_Context_atom,[deduced_forward,false,FormulaA],_Depth,tabled_true,[deduced_forward,false,FormulaA]) :-
               deduceSurface_false(__Context_atom,FormulaA,_Explaination).

moo_I_conclusion(_Context_atom,[consultion,true,FormulaA],_Depth,tabled_true,[consultion,FormulaA]) :-
               consultation(__Context_atom,FormulaA).

moo_I_conclusion(_Context_atom,[consult,true,FormulaA],_Depth,tabled_true,[consult,FormulaA]) :-
...
assert(Assert_chars):-
            once((convInsert(Assert_chars,PrologForm),tell_sterm(PrologForm))).
...
tqd:- cd('C:\cygwin\tks\moo\design\test_questions').
% ======================================================================
...
conv_pred(_C,[Pred|ARGS],[browser_only,[Pred|ARGS]]):-member(Pred,[
                                    ...
                                    arg9Format,
                                    argFormat,
                                    'STANDARD-BasedProject',
                                    'STANDARDConstant',
                                    'STANDARDExpression',
                                    'STANDARDFormula',
                                    'STANDARDIndexedTerm',
                                    'STANDARDAssertionDirection',
                                    'STANDARDlist',
                                    cyckifrovenotes,
                                    'STANDARDlistsMt',
                                    'STANDARDSystemAtom',
                                    'STANDARDSystemInteger',
                                    'prettyName',
                                    'STANDARDSystemKeyword',
                                    'STANDARDSystemList',
                                    'STANDARDSystemRealNumber',
                                    'STANDARDSystemString',
                                    'STANDARDSystemSymbol',
                                    'STANDARDTerm',
                                    'constantID',
                                    'constanprovename',
                                    substring,
...
Channel reach the author send email to aabyan@wwc.edu
or Anthony Aaby
...
/********************************  The End ***********************************/
         ...
         /********************************  The End ***********************************/
/* File:      consult.P
** $Id: logicmoo_unused.pl,v 1.1 2002-12-03 08:34:29 dmiles Exp $
*/
/*
...
%-------------------------------------------------------------------------
% multifile_apply(ModName, Module) adds a request
...
%-------------------------------------------------------------------------
% multifile_request(ModName) adds a request
...
tabled_this_term(NT,ModName):-member(ModName,['belief_engine/moo_dynamics','belief_engine/startup_persist']),!.
...
declausify1([cl(Head,Body)|More],or((HeadP:-BodyP),MoreRequests)):-!,  %Break clause list
       conv_det(Head,HeadP),conv_det(Body,BodyP), %Recurse for OR
          declausify1(More,MoreRequests).
...
% ===================================================================
%  moo_D_legal_modes_check(Pred,ArgNum,Arg)
% ===================================================================


moo_D_legal_modes_check(Pred,Args,C):-
         (nth_mode_list(Pred,MODES,C)),!,
         check_legal_modes(Args,MODES,C).
moo_D_legal_modes_check(_Pred,_Args,_C):-!.
...
% constrain_wff_argtypes/2 is imported from module(moo_arg_domains)
% ======================================================================
...
request_wrap(H):-asserta(mooCache(held_wrapped(H))).
request_wrap(H):-atom_concat('~',H,NH),asserta(mooCache(held_wrapped_n(NH))).

held_wrapped(NH):-mooCache(held_wrapped(NH)).
held_wrapped_n(NH):-mooCache(held_wrapped_n(NH)).
...
get_predicate_hash(X,Y,A,Q):-mooCache(PredR,predicate_hash(X,Y,Q)),!.
get_predicate_hash(X,Y,Z,Q):-
        logOnFailure(make_get_predicate_hash(X,Y,Z,Q)),!,
        asserta(mooCache(PredR,predicate_hash(X,Y,Q))).
...
get_predicate_nth_domains(Predicate,Arity,ClassList):-mooCache(PredR,domain_set(Predicate,ClassList)),!.
get_predicate_nth_domains(Predicate,Arity,ClassList):-
        logOnFailure(make_get_predicate_nth_domains(Predicate,Arity,ClassList)),
        asserta(mooCache(PredR,domain_set(Predicate,ClassList))),!.
...
get_class_hash(C,H):-mooCache(PredR,class_hash(C,H)),!.
get_class_hash(C,H):-class_hash0(C,H),!,
        asserta(mooCache(PredR,class_hash(C,H))),!.
get_class_hash(_,'Entity').

% is_subclass_of/2 is imported from moo_surface_belief
