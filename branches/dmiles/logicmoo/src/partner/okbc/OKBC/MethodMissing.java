...
public class MethodMissing extends AbstractError {
  public Node okbcop = null;

  public MethodMissing () {}

  public MethodMissing (Node the_okbcop,
                        Node the_kb) {
    okbcop = the_okbcop;
    kb = the_kb;
  }
  ...
  public void init_from_plist (Node plist) {
    okbcop = 
      plistGet(Symbol.keyword("OKBCOP"), plist);
    kb = 
  ...
  public Node decode_to_plist() {
    return Cons.append_cons(Cons.list(Symbol.keyword("OKBCOP"),
                                      (okbcop == null ?
                                       Node._NIL :
                                       okbcop),
                                      Symbol.keyword("KB"),
