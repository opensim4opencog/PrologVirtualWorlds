...
public class NotCoercibleToFrame extends AbstractError {
  public Node frame = null;

  public NotCoercibleToFrame () {}

  public NotCoercibleToFrame (Node the_frame,
                              Node the_kb) {
    frame = the_frame;
    kb = the_kb;
  }
  ...
  public String report () {
    return "Object " +
           frame +
           " is not coercible to a frame for " +
           kb;
  }
}