...
public class ReadOnlyViolation extends AbstractError {

  public ReadOnlyViolation () {}

  public ReadOnlyViolation (Node the_kb) {
    kb = the_kb;
  }
  ...
  public Node decode_to_plist() {
    return Cons.append_cons(Cons.list(Symbol.keyword("KB"),
                                      (kb == null ?
                                       Node._NIL :
                                       kb)),
