% ===================================================================
% PURPOSE
% This File is the bootstrap for the Moo Infence engine For B-Prolog
...
% http://www.swi.psy.uva.nl/projects/SWI-Prolog/Manual/sec-3.37.html
% TODO Port
get_time(6667). 
...
% http://www.swi.psy.uva.nl/projects/SWI-Prolog/Manual/sec-3.20.html#numbervars/4

numbervars(X,_,Y,Z):-numbervars(X,Y,Z).
  
% http://www.swi.psy.uva.nl/projects/SWI-Prolog/Manual/sec-3.28.html#arithmetic_function/1
...
% http://www.swi.psy.uva.nl/projects/SWI-Prolog/Manual/sec-3.3.html#make/0

%make.

% http://www.swi.psy.uva.nl/projects/SWI-Prolog/Manual/sec-3.14.html#index/1

% http://www.swi.psy.uva.nl/projects/SWI-Prolog/Manual/sec-3.21.html#concat_atom/2
...
% http://www.swi.psy.uva.nl/projects/SWI-Prolog/Manual/sec-3.42.html#style_check/1

style_check(_).  

% http://www.swi.psy.uva.nl/projects/SWI-Prolog/Manual/sec-3.8.html#ignore/1

ignore(X):-once((call(X);true)).

% http://www.swi.psy.uva.nl/projects/SWI-Prolog/Manual/sec-3.38.html#absolute_file_name/2

absolute_file_name(X,X).

% http://www.swi.psy.uva.nl/projects/SWI-Prolog/Manual/sec-3.5.html#string/1

string(VAR):-var(VAR),!,fail.
string([I|_]):-integer(I).

% http://www.swi.psy.uva.nl/projects/SWI-Prolog/Manual/sec-3.30.html#list_to_set/2

list_to_set(List1,List2):-sort(List1,List2).

% http://www.swi.psy.uva.nl/projects/SWI-Prolog/Manual/sec-3.29.html#memberchk/2
...
% http://www.swi.psy.uva.nl/projects/SWI-Prolog/Manual/sec-3.6.html#unify_with_occurs_check/2

unify_with_occurs_check(X,X).

% http://www.swi.psy.uva.nl/projects/SWI-Prolog/Manual/sec-3.21.html#atom_to_term/3

atom_to_term(Atom,Term,Vars):-parse_atom(Atom,Term,Vars).

% http://www.swi.psy.uva.nl/projects/SWI-Prolog/Manual/sec-3.30.html#subtract/3
...
unnumbervars(Numbered,Unnumbered):-
	getPrologVars(Numbered,List,_,_),  % Defined in moo_utility.P
	recopy_each_var(Numbered,List,Unnumbered).

recopy_each_var(Unnumbered,[],Unnumbered).
recopy_each_var(Numbered,[V|List],Unnumbered):-
	subst(Numbered,V,_NewVar,M),   % Defined in moo_utility.P
	recopy_each_var(M,List,Unnumbered),!.
		
% http://www.swi.psy.uva.nl/projects/SWI-Prolog/Manual/sec-3.21.html#term_to_atom/2
...
% http://www.swi.psy.uva.nl/projects/SWI-Prolog/Manual/sec-3.35.html#format/2

writeFmt(Format,Args):-!,current_output(Stream),writeFmt(Stream,Format,Args).

%http://www.swi.psy.uva.nl/projects/SWI-Prolog/Manual/sec-3.35.html#format/3
...
nl(Steam):-nl. %fput_chars(Stream,[10]).

writeFmt(Loc,[],Args):-!.
writeFmt(user_error,F,Args):-!,
	writeFmt(user_output,F,Args).

writeFmt(Loc,Atom,Args):-
	atom(Atom),
...
% http://www.swi.psy.uva.nl/projects/SWI-Prolog/Manual/sec-3.35.html#sformat/3
