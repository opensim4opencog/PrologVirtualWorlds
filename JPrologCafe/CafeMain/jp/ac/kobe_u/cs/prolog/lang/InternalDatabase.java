...
public class InternalDatabase implements Serializable {
  ...
  /** An array of <code>Object</code> entries. */
  ...
  public int insert(Object t) {
    try {
      ...
      Object[] new_buffer = new Object[len + 10000];
      for (int i = 0; i < len; i++) {
  ...
  public void show() {
    if (empty()) System.out.println("{internal database is empty!}");
