 ...
 *     boolean r1 = true;
 *     boolean r2 = true;
 *     Object a1[] = {Prolog.makeInteger(4), Prolog.makeVariable()};
 *     Object a2[] = {Prolog.makeInteger(8), Prolog.makeVariable()};
 *
 *     PrologControl e1 = new PrologControl();
 *     PrologControl e2 = new PrologControl();
 *     Object v1 = Prolog.makeVariable();
 *     Object v2 = Prolog.makeVariable();
...
public class PrologControl implements Runnable, Serializable {
   ...
   */
  public void setPredicate(Predicate p, Object[] args) {
    code = p;
   ...
   */
  public void setPredicate(Object t) {
    try {
      //	    Class clazz = PredicateEncoder.getClass("jp.ac.kobe_u.cs.prolog.builtin", "call", 1);
      Class clazz = engine.pcl.loadPredicateClass("jp.ac.kobe_u.cs.prolog.builtin", "call", 1, true);
      Object[] args = { engine.copy(t) };
   ...
   * @see #run
   */
  public synchronized boolean execute(Predicate p, Object[] args) {
    engine.init();
    code = p;
    code.setArgument(args, new Success(this));
    ...
    try {
      main_loop: while (true) {
        while (engine.exceptionRaised == 0) {
          if (thread == null) break main_loop;
          if (code == null) {
            fail();
            break main_loop;
          }
