/* PRED_$arity_2 - at Sun Jul 13 19:55:44 PDT 2008 */
...
public class PRED_$arity_2 extends JavaPredicate {

  private static final long serialVersionUID = 4109608981683844863L;
  public Object arg1;
  public Object arg2;

  public PRED_$arity_2() {
    /* flow_0_0_EmptyBlock_1852833748
    */
    /* empty */}

  public PRED_$arity_2(Object term, Object term_0_, Predicate predicate) {
  ...
  public Predicate exec(Prolog prolog) {
    ...
    */
    ...
    term = deref(term);
    final int arity = StaticProlog.arity(term);
    if (!unify(term_1_, StaticProlog.makeInteger(arity))) return prolog.fail();
    return this.cont;
  }
  ...
  public String toPrologString(Collection newParam) {
    ...
    */
    return "$arity(" + this.arg1 + "," + this.arg2 + ")";
  }
}
