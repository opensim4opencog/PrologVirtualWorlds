...
go(N) :-
	measure(poly_10(N), dummypoly_10(N), Utime,Gtime,System),
	nl, write(bench(poly_10,N,Utime,Gtime,System)),write('.'),nl.
...
dummypoly_10(_) :- dummypoly_10, fail.
dummypoly_10(0) :- !.
dummypoly_10(N) :-
    M is N - 1, dummypoly_10(M).
...
poly_10 :- test_poly(P), poly_exp(10, P, _), !, fail.
