...
go :-
	measure(queens1_20,true,Utime,Gtime,System),
        nl, write(bench(queens_16,40,Utime,Gtime,System)),write('.').

queens1_40 :- queens1_20, fail.
queens1_40 :- queens1_20, fail.
queens1_40.

queens1_20 :- queens1(16), fail.
queens1_20 :- queens1(16), fail.
queens1_20 :- queens1(16), fail.
queens1_20 :- queens1(16), fail.
queens1_20 :- queens1(16), fail.
...
queens1_20 :- queens1(16), fail.
queens1_20 :- queens1(16), fail.
queens1_20 :- write('next round'), nl.
...
not_attack([Y|Ys],X,N):-
	Tmp1 is Y + N, not(X == Tmp1), 
	Tmp2 is Y - N, not(X == Tmp2),
	N1 is N + 1,
	not_attack(Ys,X,N1).
