...
:-op(1150,fx,dynamic_transparent).

dynamic_transparent(PredN):-
   dynamic(PredN),module_transparent(PredN),multifile(PredN).

:-dynamic_transparent(valueOf/3).
:-dynamic_transparent(typeOf/3).
:-dynamic_transparent(termCyclify/2).
:-dynamic_transparent(stdio/3).
:-dynamic_transparent(server_environment/1).
:-dynamic_transparent(saved/4).
:-dynamic_transparent(random_sent/1).
:-dynamic_transparent(processRequestHook/1).
:-dynamic_transparent(opHowto/2).
:-dynamic_transparent(notifyChanges/1).
:-dynamic_transparent(mooCache/9).
:-dynamic_transparent(mooCache/8).
:-dynamic_transparent(mem_c/1).
:-dynamic_transparent(isa_mem_c/3).
:-dynamic_transparent(isa_mem_c/1).
:-dynamic_transparent(invokeTodo/2).
:-dynamic_transparent(getRegistered/3).
:-dynamic_transparent(expireOptimizationsInContext/3).
:-dynamic_transparent(default_user/1).
:-dynamic_transparent(default_channel/1).
:-dynamic_transparent(cycMutex/2).
:-dynamic_transparent(cycConnectionUsed/4).
:-dynamic_transparent(cycConnection/4).
:-dynamic_transparent(cycChatMode/1).
:-dynamic_transparent(consultation_gafs/1).
:-dynamic_transparent(clientEventUnhandled/3).
:-dynamic_transparent(clientEventPre/3).
:-dynamic_transparent(clientEvent/3).
:-dynamic_transparent(chattingWith/2).
...
extract_atomics(String,ListOfAtomics) :-getWordTokens(String,ListOfAtomics).
