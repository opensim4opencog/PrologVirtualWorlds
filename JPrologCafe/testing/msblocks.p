/*  --- Copyright University of Birmingham 1997.  All rights reserved. ---------
 >  File:           $poplocal/local/lib/msblocks.p
...
lconstant default_pause = 250;	;;; 2.5 seconds pause, default value for next variable
...
;;; removed separate version for popunderpwm A.S. Jan 1987
...
define improve(oldplan) -> newplan -> different;
	...
	dlocal source before destin after nextdest;
...
define runparser();
	...
	dlocal vedargument prwarning interrupt;
