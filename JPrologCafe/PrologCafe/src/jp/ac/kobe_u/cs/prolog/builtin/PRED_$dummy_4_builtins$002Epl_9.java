...
/**
 ...
 @version 1.0-dmiles
*/
class PRED_$dummy_4_builtins$002Epl_9 extends PredicateBase {
  ...
  public PRED_$dummy_4_builtins$002Epl_9(Object a1, Object a2, Object a3, Object a4, Object a5, Object a6, Object a7, Object a8, Object a9, Predicate cont) {
    arg1 = a1;
    arg2 = a2;
    arg3 = a3;
    arg4 = a4;
  ...
  public String toPrologString(java.util.Collection newParam) {
    return "'$dummy_4_builtins.pl'(" + argString(arg1, newParam) + "," + argString(arg2, newParam) + "," + argString(arg3, newParam) + "," + argString(arg4, newParam) + "," + argString(arg5, newParam) + "," + argString(arg6, newParam) + "," + argString(arg7, newParam) + "," + argString(arg8, newParam) + "," + argString(arg9, newParam) + ")";
  }
...
class PRED_$dummy_4_builtins$002Epl_9_1 extends PRED_$dummy_4_builtins$002Epl_9 {
  public Predicate exec(Prolog engine) {
    enter(engine);
    Object[] engine_aregs = engine.getAreg(); //anony 
    // '$dummy_4_builtins.pl'(A, B, C, D, E, F, G, H, I):-I= (<), !, E=A, '$merge'(B, [C|D], F, G, H)
    ...
    a9 = engine_aregs[9];
    cont = engine.cont;
    // '$dummy_4_builtins.pl'(A, B, C, D, E, F, G, H, I):-['$get_level'(J), '$unify'(I, <), '$cut'(J), '$unify'(E, A), '$merge'(B, [C|D], F, G, H)]
    ...
    //END inline expansion
    a11 = makeList(a3, a4);
    return exit(engine, new PRED_$merge_5(a2, a11, a6, a7, a8, cont));
  }
}
...
class PRED_$dummy_4_builtins$002Epl_9_2 extends PRED_$dummy_4_builtins$002Epl_9 {
  public Predicate exec(Prolog engine) {
    enter(engine);
    Object[] engine_aregs = engine.getAreg(); //anony 
    // '$dummy_4_builtins.pl'(A, B, C, D, E, F, G, H, I):-'$dummy_5_builtins.pl'(A, B, C, D, E, F, G, H, I)
    ...
    cont = engine.cont;
    // '$dummy_4_builtins.pl'(A, B, C, D, E, F, G, H, I):-['$dummy_5_builtins.pl'(A, B, C, D, E, F, G, H, I)]
    return exit(engine, new PRED_$dummy_5_builtins$002Epl_9(a1, a2, a3, a4, a5, a6, a7, a8, a9, cont));
  }
}
