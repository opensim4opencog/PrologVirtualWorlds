...
/**
 ...
 @version 1.0-dmiles
*/
public class PRED_catch_3 extends PredicateBase {
    ...
    public PRED_catch_3(Object a1, Object a2, Object a3, Predicate cont) {
        arg1 = a1;
        arg2 = a2;
        arg3 = a3;
        this.cont = cont;
    ...
    public String nameUQ() { return "catch"; }
...
default: return newIndexOutOfBoundsException("getarg", i0,null);  }   }
    ...
    public String toPrologString(java.util.Collection newParam) {
        return "'catch'(" + argString(arg1,newParam) + "," + argString(arg2,newParam) + "," + argString(arg3,newParam) + ")";
    }
    ...
    // catch(A, B, C):-[on_exception(B, 'jp.ac.kobe_u.cs.prolog.builtin':A, 'jp.ac.kobe_u.cs.prolog.builtin':C)]
        ...
        return exit(engine, new PRED_on_exception_3(a2, a4, a5, cont));
    }
}
