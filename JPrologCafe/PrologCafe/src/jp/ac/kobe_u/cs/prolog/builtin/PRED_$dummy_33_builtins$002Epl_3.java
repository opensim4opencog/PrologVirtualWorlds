...
/**
 ...
 @version 1.0-dmiles
*/
class PRED_$dummy_33_builtins$002Epl_3 extends PredicateBase {
    ...
    public PRED_$dummy_33_builtins$002Epl_3(Object a1, Object a2, Object a3, Predicate cont) {
        arg1 = a1;
        arg2 = a2;
        arg3 = a3;
        this.cont = cont;
    ...
    public String nameUQ() { return "$dummy_33_builtins.pl"; }
...
default: return newIndexOutOfBoundsException("getarg", i0,null);  }   }
    ...
    public String toPrologString(java.util.Collection newParam) {
        return "'$dummy_33_builtins.pl'(" + argString(arg1,newParam) + "," + argString(arg2,newParam) + "," + argString(arg3,newParam) + ")";
    }
...
class PRED_$dummy_33_builtins$002Epl_3_1 extends PRED_$dummy_33_builtins$002Epl_3 {
    ...
    // '$dummy_33_builtins.pl'(A, B, C):-A=[]
        ...
        a3 = engine_aregs[3];
        cont = engine.cont;
    // '$dummy_33_builtins.pl'(A, B, C):-['$unify'(A, [])]
...
class PRED_$dummy_33_builtins$002Epl_3_2 extends PRED_$dummy_33_builtins$002Epl_3 {
    public Predicate exec(Prolog engine) { enter(engine); Object[] engine_aregs = engine.getAreg(); //anony 
    // '$dummy_33_builtins.pl'(A, B, C):-A=[B|C]
        Object a1, a2, a3, a4;
        Predicate cont;
        a1 = engine_aregs[1];
        a2 = engine_aregs[2];
        a3 = engine_aregs[3];
        cont = engine.cont;
    // '$dummy_33_builtins.pl'(A, B, C):-['$unify'(A, [B|C])]
        a4 = makeList(a2, a3);
