...
/**
 ...
 @version 1.0-dmiles
*/
class PRED_read_tokens_3 extends PredicateBase {
    static /*Symbol*/Object s1 = makeAtom("[]");

    public Object arg1, arg2, arg3;

    public PRED_read_tokens_3(Object a1, Object a2, Object a3, Predicate cont) {
        arg1 = a1;
        arg2 = a2;
        arg3 = a3;
        this.cont = cont;
...
default: return newIndexOutOfBoundsException("getarg", i0,null);  }   }
    ...
    public String toPrologString(java.util.Collection newParam) {
        return "'read_tokens'(" + argString(arg1,newParam) + "," + argString(arg2,newParam) + "," + argString(arg3,newParam) + ")";
    }
    ...
    // read_tokens(A, B, C):-['$get_level'(D), '$read_tokens'(A, B, C, []), '$cut'(D)]
        ...
        return exit(engine, new PRED_$read_tokens_4(a1, a2, a3, s1, p1));
    }
}
