...
/**
 ...
 @version 1.0-dmiles
*/
class PRED_$dummy_22_builtins$002Epl_3 extends PredicateBase {
    static /*Symbol*/Object s1 = makeAtom("type", 1);
    static /*Symbol*/Object s2 = makeAtom("list", 1);
    static /*Symbol*/Object s3 = makeAtom("char");
    static Object[] s4 = {s3};
    static /*Structure*/Object s5 = makeStructure(s2, s4);
    static Object[] s6 = {s5};
    static /*Structure*/Object s7 = makeStructure(s1, s6);
    static /*Symbol*/Object s8 = makeAtom("name", 2);
    static /*IntegerTerm*/Object si9 = makeInteger(2);
    ...
    public PRED_$dummy_22_builtins$002Epl_3(Object a1, Object a2, Object a3, Predicate cont) {
        arg1 = a1;
        arg2 = a2;
        arg3 = a3;
        this.cont = cont;
    ...
    public String nameUQ() { return "$dummy_22_builtins.pl"; }
...
default: return newIndexOutOfBoundsException("getarg", i0,null);  }   }
    ...
    public String toPrologString(java.util.Collection newParam) {
        return "'$dummy_22_builtins.pl'(" + argString(arg1,newParam) + "," + argString(arg2,newParam) + "," + argString(arg3,newParam) + ")";
    }
...
class PRED_$dummy_22_builtins$002Epl_3_1 extends PRED_$dummy_22_builtins$002Epl_3 {
    public Predicate exec(Prolog engine) { enter(engine); Object[] engine_aregs = engine.getAreg(); //anony 
    // '$dummy_22_builtins.pl'(A, B, C):-atom_codes(C, B), !, A=C
        Object a1, a2, a3, a4;
        Predicate p1, p2;
        Predicate cont;
        a1 = engine_aregs[1];
        ...
        a3 = engine_aregs[3];
        cont = engine.cont;
    // '$dummy_22_builtins.pl'(A, B, C):-['$get_level'(D), atom_codes(C, B), '$cut'(D), '$unify'(A, C)]
        ...
        return exit(engine, new PRED_atom_codes_2(a3, a2, p2));
    }
}

class PRED_$dummy_22_builtins$002Epl_3_2 extends PRED_$dummy_22_builtins$002Epl_3 {
    public Predicate exec(Prolog engine) { enter(engine); Object[] engine_aregs = engine.getAreg(); //anony 
    // '$dummy_22_builtins.pl'(A, B, C):-illarg(type(list(char)), name(A, B), 2)
        Object a1, a2, a3, a4;
        Predicate cont;
        a1 = engine_aregs[1];
        a2 = engine_aregs[2];
    ...
    // '$dummy_22_builtins.pl'(A, B, C):-[illarg(type(list(char)), name(A, B), 2)]
        Object[] y1 = {a1, a2};
        a4 = makeStructure(s8, y1);
        return exit(engine, new PRED_illarg_3(s7, a4, si9, cont));
    }
}
