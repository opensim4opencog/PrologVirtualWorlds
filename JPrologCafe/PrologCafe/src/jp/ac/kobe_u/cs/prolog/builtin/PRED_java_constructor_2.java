...
*/
/**
 <code>java_constructor/2</code> defined in builtins.pl<br>
 @author Mutsunori Banbara (banbara@kobe-u.ac.jp)
 @author Naoyuki Tamura (tamura@kobe-u.ac.jp)
 @author Douglas R. Miles (dmiles@users.sourceforge.net) for Object(s) 
 @version 1.0-dmiles
*/
public class PRED_java_constructor_2 extends PredicateBase {

    public Object arg1, arg2;

    public PRED_java_constructor_2(Object a1, Object a2, Predicate cont) {
        arg1 = a1;
        arg2 = a2;
        this.cont = cont;
    }

    public PRED_java_constructor_2(){}
    ...
    public String nameUQ() { return "java_constructor"; }
...
default: return newIndexOutOfBoundsException("getarg", i0,null);  }   }
    ...
    public String toPrologString(java.util.Collection newParam) {
        return "'java_constructor'(" + argString(arg1,newParam) + "," + argString(arg2,newParam) + ")";
    }
