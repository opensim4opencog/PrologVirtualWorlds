...
/**
 ...
 @version 1.0-dmiles
*/
class PRED_$builtin_member_2 extends PredicateBase {
    ...
    public PRED_$builtin_member_2(Object a1, Object a2, Predicate cont) {
        arg1 = a1;
        arg2 = a2;
        this.cont = cont;
    }
    ...
    public String nameUQ() { return "$builtin_member"; }
...
default: return newIndexOutOfBoundsException("getarg", i0,null);  }   }
    ...
    public String toPrologString(java.util.Collection newParam) {
        return "'$builtin_member'(" + argString(arg1,newParam) + "," + argString(arg2,newParam) + ")";
    }
    ...
    public Predicate exec(Prolog engine) { enter(engine); Object[] engine_aregs = engine.getAreg(); 
        ...
        engine_aregs[2] = arg2;
        engine.cont = cont;
        return exit(engine, _$builtin_member_2_top);
    }
}
