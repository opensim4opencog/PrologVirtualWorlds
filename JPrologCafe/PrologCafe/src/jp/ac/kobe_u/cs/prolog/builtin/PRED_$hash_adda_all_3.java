...
/**
 ...
 @version 1.0-dmiles
*/
class PRED_$hash_adda_all_3 extends PredicateBase {
    ...
    public PRED_$hash_adda_all_3(Object a1, Object a2, Object a3, Predicate cont) {
        arg1 = a1;
        arg2 = a2;
        arg3 = a3;
        this.cont = cont;
    ...
    public String nameUQ() { return "$hash_adda_all"; }
...
default: return newIndexOutOfBoundsException("getarg", i0,null);  }   }
    ...
    public String toPrologString(java.util.Collection newParam) {
        return "'$hash_adda_all'(" + argString(arg1,newParam) + "," + argString(arg2,newParam) + "," + argString(arg3,newParam) + ")";
    }
...
class PRED_$hash_adda_all_3_2 extends PRED_$hash_adda_all_3 {
    ...
    // '$hash_adda_all'([A|B], C, D):-['$hash_adda'(C, A, D), '$hash_adda_all'(B, C, D)]
        ...
        return exit(engine, new PRED_$hash_adda_3(a2, a4, a3, p1));
    }
}
