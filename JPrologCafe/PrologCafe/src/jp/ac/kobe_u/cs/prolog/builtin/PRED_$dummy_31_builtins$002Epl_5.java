...
/**
 ...
 @version 1.0-dmiles
*/
class PRED_$dummy_31_builtins$002Epl_5 extends PredicateBase {
    ...
    public PRED_$dummy_31_builtins$002Epl_5(Object a1, Object a2, Object a3, Object a4, Object a5, Predicate cont) {
        arg1 = a1;
        arg2 = a2;
        arg3 = a3;
        arg4 = a4;
    ...
    public String nameUQ() { return "$dummy_31_builtins.pl"; }
...
default: return newIndexOutOfBoundsException("getarg", i0,null);  }   }
    ...
    public String toPrologString(java.util.Collection newParam) {
        return "'$dummy_31_builtins.pl'(" + argString(arg1,newParam) + "," + argString(arg2,newParam) + "," + argString(arg3,newParam) + "," + argString(arg4,newParam) + "," + argString(arg5,newParam) + ")";
    }
...
class PRED_$dummy_31_builtins$002Epl_5_1 extends PRED_$dummy_31_builtins$002Epl_5 {
    public Predicate exec(Prolog engine) { enter(engine); Object[] engine_aregs = engine.getAreg(); //anony 
    // '$dummy_31_builtins.pl'(A, B, C, D, E):-nonvar(D), !, E=type_error(B, C, A, D)
        ...
        a5 = engine_aregs[5];
        cont = engine.cont;
    // '$dummy_31_builtins.pl'(A, B, C, D, E):-['$get_level'(F), nonvar(D), '$cut'(F), '$unify'(E, type_error(B, C, A, D))]
...
class PRED_$dummy_31_builtins$002Epl_5_2 extends PRED_$dummy_31_builtins$002Epl_5 {
    public Predicate exec(Prolog engine) { enter(engine); Object[] engine_aregs = engine.getAreg(); //anony 
    // '$dummy_31_builtins.pl'(A, B, C, D, E):-E=instantiation_error(B, C)
        ...
        a5 = engine_aregs[5];
        cont = engine.cont;
    // '$dummy_31_builtins.pl'(A, B, C, D, E):-['$unify'(E, instantiation_error(B, C))]
        Object[] y1 = {a2, a3};
