/* PRED_get_2 - at Sun Sep 21 05:39:05 PDT 2008 */
...
/* import jp.ac.kobe_u.cs.prolog.builtin.PRED_get_2; */

public class PRED_get_2 extends PredicateBase {
  /**
   * 
   */
  private static final long serialVersionUID = 8355524120644258132L;
  ...
  public PRED_get_2() {
    /* flow_0_0_EmptyBlock_97575625
    */
    /* empty */}

  public PRED_get_2(Object a1, Object a2, Predicate cont) {
...
//    */
//    return "get(" + this.arg1 + "," + this.arg2 + ")";
//  }
    ...
    */
    ...
    try {
      ...
      for (c = in.read(); Character.isWhitespace((char) c); c = in.read()) {
        /* empty */}
      if (c < 0) {
        if (!unify(a2, PRED_get_2.INT_EOF)) return this.fail(engine);
        return this.cont;
      }
