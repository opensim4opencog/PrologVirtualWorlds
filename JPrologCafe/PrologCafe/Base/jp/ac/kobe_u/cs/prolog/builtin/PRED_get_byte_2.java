/* PRED_get_byte_2 - at Sun Sep 21 05:38:52 PDT 2008 */
...
public class PRED_get_byte_2 extends PredicateBase {
  /**
  * 
  */
  ...
  public PRED_get_byte_2() {
    /* flow_0_0_EmptyBlock_1928786358
    */
    /* empty */}

  public PRED_get_byte_2(Object a1, Object a2, Predicate cont) {
  ...
  public Predicate exec(Prolog engine) {
    ...
    */
    ...
    a2 = deref(a2);
    if (!isVariable(a2)) {
      if (!isInteger(a2)) throw new IllegalTypeException(this, 2, "in_byte", a2);
      final int n = (int) intValue(a2);//(IntegerTerm) car).longValue();;
      if ((n != -1) && ((n < 0) || (n > 255))) throw new RepresentationException(this, 2, "in_byte");
    }
    a1 = deref(a1);
    ...
    try {
      ...
      if (c < 0) {
        if (!unify(a2, PRED_get_byte_2.INT_EOF)) return this.fail(engine);
        return this.cont;
      }
      if (c > 255) throw new RepresentationException(this, 0, "byte");
